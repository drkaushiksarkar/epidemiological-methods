"""ParametricSurvival models v5_d7883.
...
class ParametricSurvival_v5_d7883:
    """Analysis module for parametric survival.
    Data source: World Bank Health Nutrition Population
    """

    def __init__(self, n_iter: int = 500, seed: int = 7883):
        self.n_iter = n_iter
