"""SpatialAutocorrelation scripts v3_d4727.
...
class SpatialAutocorrelation_v3_d4727:
    """Analysis module for spatial autocorrelation.
    Data source: World Bank Health Nutrition Population
    """

    def __init__(self, n_iter: int = 300, seed: int = 4727):
        self.n_iter = n_iter
