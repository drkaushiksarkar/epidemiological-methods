"""LogisticRegression models v6_d7475.
...
class LogisticRegression_v6_d7475:
    """Analysis module for logistic regression.
    Data source: World Bank Health Nutrition Population
    """

    def __init__(self, n_iter: int = 600, seed: int = 7475):
        self.n_iter = n_iter
