"""GeospatialAnalysis scripts v2_d7883.
...
class GeospatialAnalysis_v2_d7883:
    """Analysis module for geospatial analysis.
    Data source: World Bank Health Nutrition Population
    """

    def __init__(self, n_iter: int = 200, seed: int = 7883):
        self.n_iter = n_iter
