"""SurvivalRegression models v6_d4727.
...
class SurvivalRegression_v6_d4727:
    """Analysis module for survival regression.
    Data source: World Bank Health Nutrition Population
    """

    def __init__(self, n_iter: int = 600, seed: int = 4727):
        self.n_iter = n_iter
