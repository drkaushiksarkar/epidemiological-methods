* fixed_effects - Epidemiological Analysis v9 (d3724)
* Source: Global Burden of Disease (IHME/GBD)
* Stata 14+ required

capture log close
log using "results/fixed_effects_v9.log", replace

* ============================================
* Data preparation
* ============================================
use "data/fixed_effects_raw.dta", clear
describe
summarize
...
sts graph, by(treatment_group) ci ///
    title("fixed_effects: Kaplan-Meier Survival Estimates") ///
    ytitle("Survival Probability") xtitle("Time (months)")
graph export "figures/fixed_effects_km_v9.png", replace
