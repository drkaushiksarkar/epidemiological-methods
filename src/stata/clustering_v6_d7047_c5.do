* clustering - Disease Burden Analysis v6 (d7047)
* Source: DHS Program Survey Data
* Population-level mortality and morbidity analysis

capture log close
log using "results/clustering_burden_v6.log", replace
...
* Export results
export delimited using "output/clustering_burden_v6.csv", replace
