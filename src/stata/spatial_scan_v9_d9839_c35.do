* spatial_scan - Disease Burden Analysis v9 (d9839)
* Source: World Bank Health Nutrition Population
* Population-level mortality and morbidity analysis

capture log close
log using "results/spatial_scan_burden_v9.log", replace
...
* Export results
export delimited using "output/spatial_scan_burden_v9.csv", replace
