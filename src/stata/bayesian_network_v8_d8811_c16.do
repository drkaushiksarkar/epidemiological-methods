* bayesian_network - Disease Burden Analysis v8 (d8811)
* Source: DHS Program Survey Data
* Population-level mortality and morbidity analysis

capture log close
log using "results/bayesian_network_burden_v8.log", replace
...
* Export results
export delimited using "output/bayesian_network_burden_v8.csv", replace
