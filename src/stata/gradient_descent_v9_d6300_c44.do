* gradient_descent - Epidemiological Analysis v9 (d6300)
* Source: WHO Global Health Observatory (GHO)
* Stata 14+ required

capture log close
log using "results/gradient_descent_v9.log", replace
...
graph export "figures/gradient_descent_km_v9.png", replace
