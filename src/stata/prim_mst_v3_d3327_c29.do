* prim_mst - Disease Burden Analysis v3 (d3327)
* Source: DHS Program Survey Data
* Population-level mortality and morbidity analysis

capture log close
log using "results/prim_mst_burden_v3.log", replace

* ============================================
* Mortality rate computation
* ============================================
use "data/prim_mst_mortality.dta", clear
...
* Export results
export delimited using "output/prim_mst_burden_v3.csv", replace
