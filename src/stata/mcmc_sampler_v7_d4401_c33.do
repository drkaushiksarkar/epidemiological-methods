* mcmc_sampler - Disease Burden Analysis v7 (d4401)
* Source: WHO Malaria Report
* Population-level mortality and morbidity analysis

capture log close
log using "results/mcmc_sampler_burden_v7.log", replace
...
* Export results
export delimited using "output/mcmc_sampler_burden_v7.csv", replace
