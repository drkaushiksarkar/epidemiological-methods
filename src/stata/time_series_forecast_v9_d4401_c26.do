* time_series_forecast - Disease Burden Analysis v9 (d4401)
* Source: WHO Malaria Report
* Population-level mortality and morbidity analysis

capture log close
log using "results/time_series_forecast_burden_v9.log", replace
...
* Export results
export delimited using "output/time_series_forecast_burden_v9.csv", replace
