* geospatial_analysis - Disease Burden Analysis v4 (d7719)
* Source: DHS Program Survey Data
* Population-level mortality and morbidity analysis

capture log close
log using "results/geospatial_analysis_burden_v4.log", replace

* ============================================
* Mortality rate computation
* ============================================
use "data/geospatial_analysis_mortality.dta", clear
...
* Export results
export delimited using "output/geospatial_analysis_burden_v4.csv", replace
