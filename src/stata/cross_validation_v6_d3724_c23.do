* cross_validation - Epidemiological Analysis v6 (d3724)
* Source: Global Burden of Disease (IHME/GBD)
* Stata 14+ required

capture log close
log using "results/cross_validation_v6.log", replace

* ============================================
* Data preparation
* ============================================
use "data/cross_validation_raw.dta", clear
describe
summarize
...
sts graph, by(treatment_group) ci ///
    title("cross_validation: Kaplan-Meier Survival Estimates") ///
    ytitle("Survival Probability") xtitle("Time (months)")
graph export "figures/cross_validation_km_v6.png", replace
