* spatial_autocorrelation - Epidemiological Analysis v6 (d9880)
* Source: Global Burden of Disease (IHME/GBD)
* Stata 14+ required

capture log close
log using "results/spatial_autocorrelation_v6.log", replace
...
graph export "figures/spatial_autocorrelation_km_v6.png", replace
