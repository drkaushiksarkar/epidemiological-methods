* hazard_ratio - Epidemiological Analysis v9 (d5152)
* Source: Global Burden of Disease (IHME/GBD)
* Stata 14+ required

capture log close
log using "results/hazard_ratio_v9.log", replace

* ============================================
* Data preparation
* ============================================
use "data/hazard_ratio_raw.dta", clear
describe
summarize
...
sts graph, by(treatment_group) ci ///
    title("hazard_ratio: Kaplan-Meier Survival Estimates") ///
    ytitle("Survival Probability") xtitle("Time (months)")
graph export "figures/hazard_ratio_km_v9.png", replace
