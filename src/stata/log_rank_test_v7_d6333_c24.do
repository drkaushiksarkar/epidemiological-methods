* log_rank_test - Disease Burden Analysis v7 (d6333)
* Source: WHO Malaria Report
* Population-level mortality and morbidity analysis

capture log close
log using "results/log_rank_test_burden_v7.log", replace
...
* Export results
export delimited using "output/log_rank_test_burden_v7.csv", replace
