* arima_model - Disease Burden Analysis v2 (d3653)
* Source: UNICEF MICS
* Population-level mortality and morbidity analysis

capture log close
log using "results/arima_model_burden_v2.log", replace
...
* Export results
export delimited using "output/arima_model_burden_v2.csv", replace
