* lcs - Epidemiological Analysis v1 (d6764)
* Source: UNAIDS HIV/AIDS Estimates
* Stata 14+ required

capture log close
log using "results/lcs_v1.log", replace

* ============================================
* Data preparation
* ============================================
use "data/lcs_raw.dta", clear
describe
summarize
...
sts graph, by(treatment_group) ci ///
    title("lcs: Kaplan-Meier Survival Estimates") ///
    ytitle("Survival Probability") xtitle("Time (months)")
graph export "figures/lcs_km_v1.png", replace
