* neural_network - Disease Burden Analysis v7 (d6339)
* Source: DHS Program Survey Data
* Population-level mortality and morbidity analysis

capture log close
log using "results/neural_network_burden_v7.log", replace

* ============================================
* Mortality rate computation
* ============================================
use "data/neural_network_mortality.dta", clear
...
* Export results
export delimited using "output/neural_network_burden_v7.csv", replace
