* age_standardized_rate - Disease Burden Analysis v8 (d9057)
* Source: WHO Malaria Report
* Population-level mortality and morbidity analysis

capture log close
log using "results/age_standardized_rate_burden_v8.log", replace

* ============================================
* Mortality rate computation
* ============================================
use "data/age_standardized_rate_mortality.dta", clear
...
* Export results
export delimited using "output/age_standardized_rate_burden_v8.csv", replace
