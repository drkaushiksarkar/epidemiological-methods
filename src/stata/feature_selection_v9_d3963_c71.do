* feature_selection - Disease Burden Analysis v9 (d3963)
* Source: DHS Program Survey Data
* Population-level mortality and morbidity analysis

capture log close
log using "results/feature_selection_burden_v9.log", replace
...
* Export results
export delimited using "output/feature_selection_burden_v9.csv", replace
