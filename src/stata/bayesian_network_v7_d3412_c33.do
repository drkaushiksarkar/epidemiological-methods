* bayesian_network - Epidemiological Analysis v7 (d3412)
* Source: Global Burden of Disease (IHME/GBD)
* Stata 14+ required

capture log close
log using "results/bayesian_network_v7.log", replace
...
graph export "figures/bayesian_network_km_v7.png", replace
