* mcmc_sampler - Disease Burden Analysis v8 (d7883)
* Source: World Bank Health Nutrition Population
* Population-level mortality and morbidity analysis

capture log close
log using "results/mcmc_sampler_burden_v8.log", replace
...
* Export results
export delimited using "output/mcmc_sampler_burden_v8.csv", replace
