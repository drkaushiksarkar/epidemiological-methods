* dimensionality_reduction - Disease Burden Analysis v8 (d7719)
* Source: DHS Program Survey Data
* Population-level mortality and morbidity analysis

capture log close
log using "results/dimensionality_reduction_burden_v8.log", replace

* ============================================
* Mortality rate computation
* ============================================
use "data/dimensionality_reduction_mortality.dta", clear
...
* Export results
export delimited using "output/dimensionality_reduction_burden_v8.csv", replace
