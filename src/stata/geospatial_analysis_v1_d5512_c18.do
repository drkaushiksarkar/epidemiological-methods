* geospatial_analysis - Epidemiological Analysis v1 (d5512)
* Source: Global Burden of Disease (IHME/GBD)
* Stata 14+ required

capture log close
log using "results/geospatial_analysis_v1.log", replace
...
graph export "figures/geospatial_analysis_km_v1.png", replace
