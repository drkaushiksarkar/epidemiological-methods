* arima_model - Disease Burden Analysis v1 (d4401)
* Source: WHO Malaria Report
* Population-level mortality and morbidity analysis

capture log close
log using "results/arima_model_burden_v1.log", replace
...
* Export results
export delimited using "output/arima_model_burden_v1.csv", replace
