* gee_model - Disease Burden Analysis v4 (d5637)
* Source: WHO Malaria Report
* Population-level mortality and morbidity analysis

capture log close
log using "results/gee_model_burden_v4.log", replace
...
* Export results
export delimited using "output/gee_model_burden_v4.csv", replace
