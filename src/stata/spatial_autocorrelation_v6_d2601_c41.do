* spatial_autocorrelation - Disease Burden Analysis v6 (d2601)
* Source: WHO Malaria Report
* Population-level mortality and morbidity analysis

capture log close
log using "results/spatial_autocorrelation_burden_v6.log", replace
...
* Export results
export delimited using "output/spatial_autocorrelation_burden_v6.csv", replace
