* spatial_scan - Disease Burden Analysis v5 (d9757)
* Source: World Bank World Development Indicators (WDI)
* Population-level mortality and morbidity analysis

capture log close
log using "results/spatial_scan_burden_v5.log", replace
...
* Export results
export delimited using "output/spatial_scan_burden_v5.csv", replace
