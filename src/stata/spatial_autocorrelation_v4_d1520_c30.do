* spatial_autocorrelation - Epidemiological Analysis v4 (d1520)
* Source: UNAIDS HIV/AIDS Estimates
* Stata 14+ required

capture log close
log using "results/spatial_autocorrelation_v4.log", replace
...
graph export "figures/spatial_autocorrelation_km_v4.png", replace
