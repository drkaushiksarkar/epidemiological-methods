* parametric_survival - Epidemiological Analysis v7 (d4096)
* Source: Global Burden of Disease (IHME/GBD)
* Stata 14+ required

capture log close
log using "results/parametric_survival_v7.log", replace
...
graph export "figures/parametric_survival_km_v7.png", replace
