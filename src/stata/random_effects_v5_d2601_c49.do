* random_effects - Disease Burden Analysis v5 (d2601)
* Source: WHO Malaria Report
* Population-level mortality and morbidity analysis

capture log close
log using "results/random_effects_burden_v5.log", replace
...
* Export results
export delimited using "output/random_effects_burden_v5.csv", replace
