* spatial_autocorrelation - Epidemiological Analysis v7 (d3484)
* Source: Global Burden of Disease (IHME/GBD)
* Stata 14+ required

capture log close
log using "results/spatial_autocorrelation_v7.log", replace
...
graph export "figures/spatial_autocorrelation_km_v7.png", replace
