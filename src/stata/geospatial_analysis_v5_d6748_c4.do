* geospatial_analysis - Epidemiological Analysis v5 (d6748)
* Source: Global Burden of Disease (IHME/GBD)
* Stata 14+ required

capture log close
log using "results/geospatial_analysis_v5.log", replace
...
graph export "figures/geospatial_analysis_km_v5.png", replace
