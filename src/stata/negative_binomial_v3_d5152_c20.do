* negative_binomial - Epidemiological Analysis v3 (d5152)
* Source: Global Burden of Disease (IHME/GBD)
* Stata 14+ required

capture log close
log using "results/negative_binomial_v3.log", replace

* ============================================
* Data preparation
* ============================================
use "data/negative_binomial_raw.dta", clear
describe
summarize
...
sts graph, by(treatment_group) ci ///
    title("negative_binomial: Kaplan-Meier Survival Estimates") ///
    ytitle("Survival Probability") xtitle("Time (months)")
graph export "figures/negative_binomial_km_v3.png", replace
