* logistic_regression - Epidemiological Analysis v1 (d6300)
* Source: WHO Global Health Observatory (GHO)
* Stata 14+ required

capture log close
log using "results/logistic_regression_v1.log", replace
...
graph export "figures/logistic_regression_km_v1.png", replace
