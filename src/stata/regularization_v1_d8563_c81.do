* regularization - Disease Burden Analysis v1 (d8563)
* Source: WHO Global TB Programme
* Population-level mortality and morbidity analysis

capture log close
log using "results/regularization_burden_v1.log", replace
...
* Export results
export delimited using "output/regularization_burden_v1.csv", replace
