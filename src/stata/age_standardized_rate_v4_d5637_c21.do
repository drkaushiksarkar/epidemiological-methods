* age_standardized_rate - Disease Burden Analysis v4 (d5637)
* Source: WHO Malaria Report
* Population-level mortality and morbidity analysis

capture log close
log using "results/age_standardized_rate_burden_v4.log", replace
...
* Export results
export delimited using "output/age_standardized_rate_burden_v4.csv", replace
