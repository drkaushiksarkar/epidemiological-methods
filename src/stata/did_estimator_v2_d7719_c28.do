* did_estimator - Disease Burden Analysis v2 (d7719)
* Source: DHS Program Survey Data
* Population-level mortality and morbidity analysis

capture log close
log using "results/did_estimator_burden_v2.log", replace

* ============================================
* Mortality rate computation
* ============================================
use "data/did_estimator_mortality.dta", clear
...
* Export results
export delimited using "output/did_estimator_burden_v2.csv", replace
