* meta_analysis - Disease Burden Analysis v7 (d5637)
* Source: WHO Malaria Report
* Population-level mortality and morbidity analysis

capture log close
log using "results/meta_analysis_burden_v7.log", replace
...
* Export results
export delimited using "output/meta_analysis_burden_v7.csv", replace
