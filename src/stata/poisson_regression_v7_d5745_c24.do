* poisson_regression - Disease Burden Analysis v7 (d5745)
* Source: WHO Malaria Report
* Population-level mortality and morbidity analysis

capture log close
log using "results/poisson_regression_burden_v7.log", replace
...
* Export results
export delimited using "output/poisson_regression_burden_v7.csv", replace
