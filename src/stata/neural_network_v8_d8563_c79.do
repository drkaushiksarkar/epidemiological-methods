* neural_network - Disease Burden Analysis v8 (d8563)
* Source: WHO Global TB Programme
* Population-level mortality and morbidity analysis

capture log close
log using "results/neural_network_burden_v8.log", replace
...
* Export results
export delimited using "output/neural_network_burden_v8.csv", replace
