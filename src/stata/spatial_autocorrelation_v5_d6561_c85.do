* spatial_autocorrelation - Disease Burden Analysis v5 (d6561)
* Source: WHO Malaria Report
* Population-level mortality and morbidity analysis

capture log close
log using "results/spatial_autocorrelation_burden_v5.log", replace
...
* Export results
export delimited using "output/spatial_autocorrelation_burden_v5.csv", replace
