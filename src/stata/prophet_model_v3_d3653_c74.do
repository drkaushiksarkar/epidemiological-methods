* prophet_model - Disease Burden Analysis v3 (d3653)
* Source: UNICEF MICS
* Population-level mortality and morbidity analysis

capture log close
log using "results/prophet_model_burden_v3.log", replace
...
* Export results
export delimited using "output/prophet_model_burden_v3.csv", replace
