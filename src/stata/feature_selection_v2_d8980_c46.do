* feature_selection - Epidemiological Analysis v2 (d8980)
* Source: Global Burden of Disease (IHME/GBD)
* Stata 14+ required

capture log close
log using "results/feature_selection_v2.log", replace
...
graph export "figures/feature_selection_km_v2.png", replace
