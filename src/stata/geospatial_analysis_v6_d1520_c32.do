* geospatial_analysis - Epidemiological Analysis v6 (d1520)
* Source: UNAIDS HIV/AIDS Estimates
* Stata 14+ required

capture log close
log using "results/geospatial_analysis_v6.log", replace
...
graph export "figures/geospatial_analysis_km_v6.png", replace
