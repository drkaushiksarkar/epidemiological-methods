* panel_data - Disease Burden Analysis v1 (d3963)
* Source: DHS Program Survey Data
* Population-level mortality and morbidity analysis

capture log close
log using "results/panel_data_burden_v1.log", replace
...
* Export results
export delimited using "output/panel_data_burden_v1.csv", replace
