* cross_validation - Disease Burden Analysis v2 (d9717)
* Source: WHO Malaria Report
* Population-level mortality and morbidity analysis

capture log close
log using "results/cross_validation_burden_v2.log", replace
...
* Export results
export delimited using "output/cross_validation_burden_v2.csv", replace
