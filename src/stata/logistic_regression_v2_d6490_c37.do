* logistic_regression - Epidemiological Analysis v2 (d6490)
* Source: FAO FAOSTAT
* Stata 14+ required

capture log close
log using "results/logistic_regression_v2.log", replace
...
graph export "figures/logistic_regression_km_v2.png", replace
