* spatial_autocorrelation - Epidemiological Analysis v5 (d7064)
* Source: UNAIDS HIV/AIDS Estimates
* Stata 14+ required

capture log close
log using "results/spatial_autocorrelation_v5.log", replace
...
graph export "figures/spatial_autocorrelation_km_v5.png", replace
