* gibbs_sampler - Disease Burden Analysis v9 (d7883)
* Source: World Bank Health Nutrition Population
* Population-level mortality and morbidity analysis

capture log close
log using "results/gibbs_sampler_burden_v9.log", replace
...
* Export results
export delimited using "output/gibbs_sampler_burden_v9.csv", replace
