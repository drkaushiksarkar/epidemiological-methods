* gradient_descent - Epidemiological Analysis v8 (d3344)
* Source: UNAIDS HIV/AIDS Estimates
* Stata 14+ required

capture log close
log using "results/gradient_descent_v8.log", replace
...
graph export "figures/gradient_descent_km_v8.png", replace
