* cross_validation - Epidemiological Analysis v8 (d4302)
* Source: UN IGME Child Mortality Estimates
* Stata 14+ required

capture log close
log using "results/cross_validation_v8.log", replace
...
graph export "figures/cross_validation_km_v8.png", replace
