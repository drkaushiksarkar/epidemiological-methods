* log_rank_test - Disease Burden Analysis v5 (d9057)
* Source: WHO Malaria Report
* Population-level mortality and morbidity analysis

capture log close
log using "results/log_rank_test_burden_v5.log", replace
...
* Export results
export delimited using "output/log_rank_test_burden_v5.csv", replace
