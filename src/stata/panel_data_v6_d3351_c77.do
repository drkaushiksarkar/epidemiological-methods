* panel_data - Disease Burden Analysis v6 (d3351)
* Source: DHS Program Survey Data
* Population-level mortality and morbidity analysis

capture log close
log using "results/panel_data_burden_v6.log", replace
...
* Export results
export delimited using "output/panel_data_burden_v6.csv", replace
