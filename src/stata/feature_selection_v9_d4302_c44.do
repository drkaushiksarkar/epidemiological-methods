* feature_selection - Epidemiological Analysis v9 (d4302)
* Source: UN IGME Child Mortality Estimates
* Stata 14+ required

capture log close
log using "results/feature_selection_v9.log", replace
...
graph export "figures/feature_selection_km_v9.png", replace
