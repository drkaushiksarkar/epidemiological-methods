* bym_model - Disease Burden Analysis v5 (d8849)
* Source: UNICEF MICS
* Population-level mortality and morbidity analysis

capture log close
log using "results/bym_model_burden_v5.log", replace
...
* Export results
export delimited using "output/bym_model_burden_v5.csv", replace
