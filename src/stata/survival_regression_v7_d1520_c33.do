* survival_regression - Epidemiological Analysis v7 (d1520)
* Source: UNAIDS HIV/AIDS Estimates
* Stata 14+ required

capture log close
log using "results/survival_regression_v7.log", replace
...
graph export "figures/survival_regression_km_v7.png", replace
