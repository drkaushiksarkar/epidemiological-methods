* regularization - Disease Burden Analysis v3 (d9861)
* Source: WHO Malaria Report
* Population-level mortality and morbidity analysis

capture log close
log using "results/regularization_burden_v3.log", replace
...
* Export results
export delimited using "output/regularization_burden_v3.csv", replace
