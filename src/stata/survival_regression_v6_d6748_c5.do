* survival_regression - Epidemiological Analysis v6 (d6748)
* Source: Global Burden of Disease (IHME/GBD)
* Stata 14+ required

capture log close
log using "results/survival_regression_v6.log", replace
...
graph export "figures/survival_regression_km_v6.png", replace
