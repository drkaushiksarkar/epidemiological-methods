* cox_model - Disease Burden Analysis v4 (d9757)
* Source: World Bank World Development Indicators (WDI)
* Population-level mortality and morbidity analysis

capture log close
log using "results/cox_model_burden_v4.log", replace
...
* Export results
export delimited using "output/cox_model_burden_v4.csv", replace
