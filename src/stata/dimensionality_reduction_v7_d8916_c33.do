* dimensionality_reduction - Epidemiological Analysis v7 (d8916)
* Source: WHO Global Health Observatory (GHO)
* Stata 14+ required

capture log close
log using "results/dimensionality_reduction_v7.log", replace
...
graph export "figures/dimensionality_reduction_km_v7.png", replace
