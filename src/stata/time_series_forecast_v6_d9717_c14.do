* time_series_forecast - Disease Burden Analysis v6 (d9717)
* Source: WHO Malaria Report
* Population-level mortality and morbidity analysis

capture log close
log using "results/time_series_forecast_burden_v6.log", replace
...
* Export results
export delimited using "output/time_series_forecast_burden_v6.csv", replace
