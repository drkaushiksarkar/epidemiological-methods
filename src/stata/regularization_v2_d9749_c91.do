* regularization - Disease Burden Analysis v2 (d9749)
* Source: UNICEF MICS
* Population-level mortality and morbidity analysis

capture log close
log using "results/regularization_burden_v2.log", replace
...
* Export results
export delimited using "output/regularization_burden_v2.csv", replace
