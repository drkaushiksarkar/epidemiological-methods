* cross_validation - Epidemiological Analysis v2 (d3552)
* Source: WHO Global Health Observatory (GHO)
* Stata 14+ required

capture log close
log using "results/cross_validation_v2.log", replace
...
graph export "figures/cross_validation_km_v2.png", replace
