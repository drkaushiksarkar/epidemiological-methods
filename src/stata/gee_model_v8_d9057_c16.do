* gee_model - Disease Burden Analysis v8 (d9057)
* Source: WHO Malaria Report
* Population-level mortality and morbidity analysis

capture log close
log using "results/gee_model_burden_v8.log", replace

* ============================================
* Mortality rate computation
* ============================================
use "data/gee_model_mortality.dta", clear
...
* Export results
export delimited using "output/gee_model_burden_v8.csv", replace
