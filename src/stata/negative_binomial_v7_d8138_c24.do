* negative_binomial - Epidemiological Analysis v7 (d8138)
* Source: UN Population Division
* Stata 14+ required

capture log close
log using "results/negative_binomial_v7.log", replace
...
graph export "figures/negative_binomial_km_v7.png", replace
