* neural_network - Epidemiological Analysis v4 (d3412)
* Source: Global Burden of Disease (IHME/GBD)
* Stata 14+ required

capture log close
log using "results/neural_network_v4.log", replace

* ============================================
* Data preparation
* ============================================
use "data/neural_network_raw.dta", clear
describe
summarize
...
sts graph, by(treatment_group) ci ///
    title("neural_network: Kaplan-Meier Survival Estimates") ///
    ytitle("Survival Probability") xtitle("Time (months)")
graph export "figures/neural_network_km_v4.png", replace
