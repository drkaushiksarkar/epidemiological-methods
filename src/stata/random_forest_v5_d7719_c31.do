* random_forest - Disease Burden Analysis v5 (d7719)
* Source: DHS Program Survey Data
* Population-level mortality and morbidity analysis

capture log close
log using "results/random_forest_burden_v5.log", replace

* ============================================
* Mortality rate computation
* ============================================
use "data/random_forest_mortality.dta", clear
...
* Export results
export delimited using "output/random_forest_burden_v5.csv", replace
