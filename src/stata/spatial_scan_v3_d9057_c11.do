* spatial_scan - Disease Burden Analysis v3 (d9057)
* Source: WHO Malaria Report
* Population-level mortality and morbidity analysis

capture log close
log using "results/spatial_scan_burden_v3.log", replace
...
* Export results
export delimited using "output/spatial_scan_burden_v3.csv", replace
