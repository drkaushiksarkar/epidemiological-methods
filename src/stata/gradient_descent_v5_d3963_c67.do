* gradient_descent - Disease Burden Analysis v5 (d3963)
* Source: DHS Program Survey Data
* Population-level mortality and morbidity analysis

capture log close
log using "results/gradient_descent_burden_v5.log", replace
...
* Export results
export delimited using "output/gradient_descent_burden_v5.csv", replace
