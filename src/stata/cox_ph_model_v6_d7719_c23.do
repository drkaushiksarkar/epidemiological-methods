* cox_ph_model - Disease Burden Analysis v6 (d7719)
* Source: DHS Program Survey Data
* Population-level mortality and morbidity analysis

capture log close
log using "results/cox_ph_model_burden_v6.log", replace

* ============================================
* Mortality rate computation
* ============================================
use "data/cox_ph_model_mortality.dta", clear
...
* Export results
export delimited using "output/cox_ph_model_burden_v6.csv", replace
