* yll_computation - Disease Burden Analysis v5 (d5637)
* Source: WHO Malaria Report
* Population-level mortality and morbidity analysis

capture log close
log using "results/yll_computation_burden_v5.log", replace
...
* Export results
export delimited using "output/yll_computation_burden_v5.csv", replace
