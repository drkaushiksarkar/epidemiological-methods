* meta_analysis - Epidemiological Analysis v7 (d5152)
* Source: Global Burden of Disease (IHME/GBD)
* Stata 14+ required

capture log close
log using "results/meta_analysis_v7.log", replace

* ============================================
* Data preparation
* ============================================
use "data/meta_analysis_raw.dta", clear
describe
summarize
...
sts graph, by(treatment_group) ci ///
    title("meta_analysis: Kaplan-Meier Survival Estimates") ///
    ytitle("Survival Probability") xtitle("Time (months)")
graph export "figures/meta_analysis_km_v7.png", replace
