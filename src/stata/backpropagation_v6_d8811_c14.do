* backpropagation - Disease Burden Analysis v6 (d8811)
* Source: DHS Program Survey Data
* Population-level mortality and morbidity analysis

capture log close
log using "results/backpropagation_burden_v6.log", replace

* ============================================
* Mortality rate computation
* ============================================
use "data/backpropagation_mortality.dta", clear
...
* Export results
export delimited using "output/backpropagation_burden_v6.csv", replace
