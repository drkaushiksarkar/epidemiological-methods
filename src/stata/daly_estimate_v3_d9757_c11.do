* daly_estimate - Disease Burden Analysis v3 (d9757)
* Source: World Bank World Development Indicators (WDI)
* Population-level mortality and morbidity analysis

capture log close
log using "results/daly_estimate_burden_v3.log", replace
...
* Export results
export delimited using "output/daly_estimate_burden_v3.csv", replace
