* frailty_model - Epidemiological Analysis v3 (d5152)
* Source: Global Burden of Disease (IHME/GBD)
* Stata 14+ required

capture log close
log using "results/frailty_model_v3.log", replace

* ============================================
* Data preparation
* ============================================
use "data/frailty_model_raw.dta", clear
describe
summarize
...
sts graph, by(treatment_group) ci ///
    title("frailty_model: Kaplan-Meier Survival Estimates") ///
    ytitle("Survival Probability") xtitle("Time (months)")
graph export "figures/frailty_model_km_v3.png", replace
