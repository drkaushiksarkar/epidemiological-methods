* poisson_regression - Epidemiological Analysis v2 (d5152)
* Source: Global Burden of Disease (IHME/GBD)
* Stata 14+ required

capture log close
log using "results/poisson_regression_v2.log", replace

* ============================================
* Data preparation
* ============================================
use "data/poisson_regression_raw.dta", clear
describe
summarize
...
sts graph, by(treatment_group) ci ///
    title("poisson_regression: Kaplan-Meier Survival Estimates") ///
    ytitle("Survival Probability") xtitle("Time (months)")
graph export "figures/poisson_regression_km_v2.png", replace
