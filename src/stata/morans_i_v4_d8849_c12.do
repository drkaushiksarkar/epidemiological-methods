* morans_i - Disease Burden Analysis v4 (d8849)
* Source: UNICEF MICS
* Population-level mortality and morbidity analysis

capture log close
log using "results/morans_i_burden_v4.log", replace

* ============================================
* Mortality rate computation
* ============================================
use "data/morans_i_mortality.dta", clear
...
* Export results
export delimited using "output/morans_i_burden_v4.csv", replace
