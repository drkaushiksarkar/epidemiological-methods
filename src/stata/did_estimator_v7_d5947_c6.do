* did_estimator - Disease Burden Analysis v7 (d5947)
* Source: WHO Global TB Programme
* Population-level mortality and morbidity analysis

capture log close
log using "results/did_estimator_burden_v7.log", replace
...
* Export results
export delimited using "output/did_estimator_burden_v7.csv", replace
