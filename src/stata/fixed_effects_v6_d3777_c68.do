* fixed_effects - Disease Burden Analysis v6 (d3777)
* Source: WHO Malaria Report
* Population-level mortality and morbidity analysis

capture log close
log using "results/fixed_effects_burden_v6.log", replace
...
* Export results
export delimited using "output/fixed_effects_burden_v6.csv", replace
