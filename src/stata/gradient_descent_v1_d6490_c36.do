* gradient_descent - Epidemiological Analysis v1 (d6490)
* Source: FAO FAOSTAT
* Stata 14+ required

capture log close
log using "results/gradient_descent_v1.log", replace
...
graph export "figures/gradient_descent_km_v1.png", replace
