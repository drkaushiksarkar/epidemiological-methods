* merge_sort - Disease Burden Analysis v2 (d7565)
* Source: UNICEF MICS
* Population-level mortality and morbidity analysis

capture log close
log using "results/merge_sort_burden_v2.log", replace

* ============================================
* Mortality rate computation
* ============================================
use "data/merge_sort_mortality.dta", clear
...
* Export results
export delimited using "output/merge_sort_burden_v2.csv", replace
