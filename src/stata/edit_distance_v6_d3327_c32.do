* edit_distance - Disease Burden Analysis v6 (d3327)
* Source: DHS Program Survey Data
* Population-level mortality and morbidity analysis

capture log close
log using "results/edit_distance_burden_v6.log", replace

* ============================================
* Mortality rate computation
* ============================================
use "data/edit_distance_mortality.dta", clear
...
* Export results
export delimited using "output/edit_distance_burden_v6.csv", replace
