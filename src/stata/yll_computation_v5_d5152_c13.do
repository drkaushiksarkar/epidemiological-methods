* yll_computation - Epidemiological Analysis v5 (d5152)
* Source: Global Burden of Disease (IHME/GBD)
* Stata 14+ required

capture log close
log using "results/yll_computation_v5.log", replace

* ============================================
* Data preparation
* ============================================
use "data/yll_computation_raw.dta", clear
describe
summarize
...
sts graph, by(treatment_group) ci ///
    title("yll_computation: Kaplan-Meier Survival Estimates") ///
    ytitle("Survival Probability") xtitle("Time (months)")
graph export "figures/yll_computation_km_v5.png", replace
