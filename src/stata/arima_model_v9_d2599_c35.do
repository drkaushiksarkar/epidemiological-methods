* arima_model - Disease Burden Analysis v9 (d2599)
* Source: WHO Global TB Programme
* Population-level mortality and morbidity analysis

capture log close
log using "results/arima_model_burden_v9.log", replace
...
* Export results
export delimited using "output/arima_model_burden_v9.csv", replace
