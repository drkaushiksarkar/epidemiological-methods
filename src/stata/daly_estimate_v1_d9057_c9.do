* daly_estimate - Disease Burden Analysis v1 (d9057)
* Source: WHO Malaria Report
* Population-level mortality and morbidity analysis

capture log close
log using "results/daly_estimate_burden_v1.log", replace
...
* Export results
export delimited using "output/daly_estimate_burden_v1.csv", replace
