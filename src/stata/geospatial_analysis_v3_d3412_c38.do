* geospatial_analysis - Epidemiological Analysis v3 (d3412)
* Source: Global Burden of Disease (IHME/GBD)
* Stata 14+ required

capture log close
log using "results/geospatial_analysis_v3.log", replace

* ============================================
* Data preparation
* ============================================
use "data/geospatial_analysis_raw.dta", clear
describe
summarize
...
sts graph, by(treatment_group) ci ///
    title("geospatial_analysis: Kaplan-Meier Survival Estimates") ///
    ytitle("Survival Probability") xtitle("Time (months)")
graph export "figures/geospatial_analysis_km_v3.png", replace
