* geospatial_analysis - Disease Burden Analysis v8 (d1233)
* Source: WHO Malaria Report
* Population-level mortality and morbidity analysis

capture log close
log using "results/geospatial_analysis_burden_v8.log", replace
...
* Export results
export delimited using "output/geospatial_analysis_burden_v8.csv", replace
