* yll_computation - Disease Burden Analysis v6 (d9839)
* Source: World Bank Health Nutrition Population
* Population-level mortality and morbidity analysis

capture log close
log using "results/yll_computation_burden_v6.log", replace

* ============================================
* Mortality rate computation
* ============================================
use "data/yll_computation_mortality.dta", clear
...
* Export results
export delimited using "output/yll_computation_burden_v6.csv", replace
