* logistic_regression - Epidemiological Analysis v6 (d4302)
* Source: UN IGME Child Mortality Estimates
* Stata 14+ required

capture log close
log using "results/logistic_regression_v6.log", replace
...
graph export "figures/logistic_regression_km_v6.png", replace
