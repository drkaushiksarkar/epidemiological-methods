* bayesian_network - Disease Burden Analysis v2 (d6561)
* Source: WHO Malaria Report
* Population-level mortality and morbidity analysis

capture log close
log using "results/bayesian_network_burden_v2.log", replace
...
* Export results
export delimited using "output/bayesian_network_burden_v2.csv", replace
