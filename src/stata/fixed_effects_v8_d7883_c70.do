* fixed_effects - Disease Burden Analysis v8 (d7883)
* Source: World Bank Health Nutrition Population
* Population-level mortality and morbidity analysis

capture log close
log using "results/fixed_effects_burden_v8.log", replace
...
* Export results
export delimited using "output/fixed_effects_burden_v8.csv", replace
