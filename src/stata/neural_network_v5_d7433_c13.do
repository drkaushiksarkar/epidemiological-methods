* neural_network - Disease Burden Analysis v5 (d7433)
* Source: UNICEF MICS
* Population-level mortality and morbidity analysis

capture log close
log using "results/neural_network_burden_v5.log", replace
...
* Export results
export delimited using "output/neural_network_burden_v5.csv", replace
