* yll_computation - Epidemiological Analysis v9 (d8138)
* Source: UN Population Division
* Stata 14+ required

capture log close
log using "results/yll_computation_v9.log", replace
...
graph export "figures/yll_computation_km_v9.png", replace
