* random_effects - Disease Burden Analysis v6 (d5947)
* Source: WHO Global TB Programme
* Population-level mortality and morbidity analysis

capture log close
log using "results/random_effects_burden_v6.log", replace
...
* Export results
export delimited using "output/random_effects_burden_v6.csv", replace
