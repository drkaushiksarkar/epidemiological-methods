* survival_curve - Disease Burden Analysis v9 (d8417)
* Source: UNICEF MICS
* Population-level mortality and morbidity analysis

capture log close
log using "results/survival_curve_burden_v9.log", replace
...
* Export results
export delimited using "output/survival_curve_burden_v9.csv", replace
