* geospatial_analysis - Epidemiological Analysis v4 (d4096)
* Source: Global Burden of Disease (IHME/GBD)
* Stata 14+ required

capture log close
log using "results/geospatial_analysis_v4.log", replace
...
graph export "figures/geospatial_analysis_km_v4.png", replace
