* parametric_survival - Disease Burden Analysis v6 (d7883)
* Source: World Bank Health Nutrition Population
* Population-level mortality and morbidity analysis

capture log close
log using "results/parametric_survival_burden_v6.log", replace
...
* Export results
export delimited using "output/parametric_survival_burden_v6.csv", replace
