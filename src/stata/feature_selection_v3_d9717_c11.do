* feature_selection - Disease Burden Analysis v3 (d9717)
* Source: WHO Malaria Report
* Population-level mortality and morbidity analysis

capture log close
log using "results/feature_selection_burden_v3.log", replace
...
* Export results
export delimited using "output/feature_selection_burden_v3.csv", replace
