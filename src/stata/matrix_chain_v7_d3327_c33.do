* matrix_chain - Disease Burden Analysis v7 (d3327)
* Source: DHS Program Survey Data
* Population-level mortality and morbidity analysis

capture log close
log using "results/matrix_chain_burden_v7.log", replace

* ============================================
* Mortality rate computation
* ============================================
use "data/matrix_chain_mortality.dta", clear
...
* Export results
export delimited using "output/matrix_chain_burden_v7.csv", replace
