* gradient_descent - Epidemiological Analysis v3 (d3724)
* Source: Global Burden of Disease (IHME/GBD)
* Stata 14+ required

capture log close
log using "results/gradient_descent_v3.log", replace

* ============================================
* Data preparation
* ============================================
use "data/gradient_descent_raw.dta", clear
describe
summarize
...
sts graph, by(treatment_group) ci ///
    title("gradient_descent: Kaplan-Meier Survival Estimates") ///
    ytitle("Survival Probability") xtitle("Time (months)")
graph export "figures/gradient_descent_km_v3.png", replace
