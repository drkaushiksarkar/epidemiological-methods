* regularization - Disease Burden Analysis v9 (d4727)
* Source: World Bank Health Nutrition Population
* Population-level mortality and morbidity analysis

capture log close
log using "results/regularization_burden_v9.log", replace
...
* Export results
export delimited using "output/regularization_burden_v9.csv", replace
