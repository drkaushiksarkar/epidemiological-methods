* fixed_effects - Disease Burden Analysis v3 (d6339)
* Source: DHS Program Survey Data
* Population-level mortality and morbidity analysis

capture log close
log using "results/fixed_effects_burden_v3.log", replace
...
* Export results
export delimited using "output/fixed_effects_burden_v3.csv", replace
