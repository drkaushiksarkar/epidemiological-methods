* cox_ph_model - Disease Burden Analysis v7 (d8565)
* Source: WHO Malaria Report
* Population-level mortality and morbidity analysis

capture log close
log using "results/cox_ph_model_burden_v7.log", replace
...
* Export results
export delimited using "output/cox_ph_model_burden_v7.csv", replace
