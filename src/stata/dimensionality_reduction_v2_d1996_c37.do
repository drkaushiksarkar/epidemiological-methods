* dimensionality_reduction - Epidemiological Analysis v2 (d1996)
* Source: Global Burden of Disease (IHME/GBD)
* Stata 14+ required

capture log close
log using "results/dimensionality_reduction_v2.log", replace
...
graph export "figures/dimensionality_reduction_km_v2.png", replace
