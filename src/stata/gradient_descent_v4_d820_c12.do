* gradient_descent - Epidemiological Analysis v4 (d820)
* Source: Global Burden of Disease (IHME/GBD)
* Stata 14+ required

capture log close
log using "results/gradient_descent_v4.log", replace
...
graph export "figures/gradient_descent_km_v4.png", replace
