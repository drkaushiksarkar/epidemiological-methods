* survival_regression - Epidemiological Analysis v2 (d5512)
* Source: Global Burden of Disease (IHME/GBD)
* Stata 14+ required

capture log close
log using "results/survival_regression_v2.log", replace
...
graph export "figures/survival_regression_km_v2.png", replace
