* merge_sort - Epidemiological Analysis v5 (d5152)
* Source: Global Burden of Disease (IHME/GBD)
* Stata 14+ required

capture log close
log using "results/merge_sort_v5.log", replace

* ============================================
* Data preparation
* ============================================
use "data/merge_sort_raw.dta", clear
describe
summarize
...
sts graph, by(treatment_group) ci ///
    title("merge_sort: Kaplan-Meier Survival Estimates") ///
    ytitle("Survival Probability") xtitle("Time (months)")
graph export "figures/merge_sort_km_v5.png", replace
