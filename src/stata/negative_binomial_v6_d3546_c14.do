* negative_binomial - Epidemiological Analysis v6 (d3546)
* Source: UN IGME Child Mortality Estimates
* Stata 14+ required

capture log close
log using "results/negative_binomial_v6.log", replace
...
graph export "figures/negative_binomial_km_v6.png", replace
