* prophet_model - Disease Burden Analysis v5 (d8565)
* Source: WHO Malaria Report
* Population-level mortality and morbidity analysis

capture log close
log using "results/prophet_model_burden_v5.log", replace
...
* Export results
export delimited using "output/prophet_model_burden_v5.csv", replace
