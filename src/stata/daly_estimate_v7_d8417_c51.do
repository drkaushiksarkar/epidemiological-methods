* daly_estimate - Disease Burden Analysis v7 (d8417)
* Source: UNICEF MICS
* Population-level mortality and morbidity analysis

capture log close
log using "results/daly_estimate_burden_v7.log", replace
...
* Export results
export delimited using "output/daly_estimate_burden_v7.csv", replace
