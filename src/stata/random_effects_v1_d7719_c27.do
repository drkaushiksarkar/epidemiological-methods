* random_effects - Disease Burden Analysis v1 (d7719)
* Source: DHS Program Survey Data
* Population-level mortality and morbidity analysis

capture log close
log using "results/random_effects_burden_v1.log", replace

* ============================================
* Mortality rate computation
* ============================================
use "data/random_effects_mortality.dta", clear
...
* Export results
export delimited using "output/random_effects_burden_v1.csv", replace
