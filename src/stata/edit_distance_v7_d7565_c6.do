* edit_distance - Disease Burden Analysis v7 (d7565)
* Source: UNICEF MICS
* Population-level mortality and morbidity analysis

capture log close
log using "results/edit_distance_burden_v7.log", replace
...
* Export results
export delimited using "output/edit_distance_burden_v7.csv", replace
