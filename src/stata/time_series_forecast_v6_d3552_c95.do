* time_series_forecast - Epidemiological Analysis v6 (d3552)
* Source: WHO Global Health Observatory (GHO)
* Stata 14+ required

capture log close
log using "results/time_series_forecast_v6.log", replace
...
graph export "figures/time_series_forecast_km_v6.png", replace
