* random_forest - Disease Burden Analysis v3 (d2599)
* Source: WHO Global TB Programme
* Population-level mortality and morbidity analysis

capture log close
log using "results/random_forest_burden_v3.log", replace
...
* Export results
export delimited using "output/random_forest_burden_v3.csv", replace
