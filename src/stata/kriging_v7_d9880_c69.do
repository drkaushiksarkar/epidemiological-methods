* kriging - Epidemiological Analysis v7 (d9880)
* Source: Global Burden of Disease (IHME/GBD)
* Stata 14+ required

capture log close
log using "results/kriging_v7.log", replace

* ============================================
* Data preparation
* ============================================
use "data/kriging_raw.dta", clear
describe
summarize
...
sts graph, by(treatment_group) ci ///
    title("kriging: Kaplan-Meier Survival Estimates") ///
    ytitle("Survival Probability") xtitle("Time (months)")
graph export "figures/kriging_km_v7.png", replace
