* hazard_ratio - Disease Burden Analysis v4 (d9057)
* Source: WHO Malaria Report
* Population-level mortality and morbidity analysis

capture log close
log using "results/hazard_ratio_burden_v4.log", replace
...
* Export results
export delimited using "output/hazard_ratio_burden_v4.csv", replace
