* negative_binomial - Disease Burden Analysis v3 (d5637)
* Source: WHO Malaria Report
* Population-level mortality and morbidity analysis

capture log close
log using "results/negative_binomial_burden_v3.log", replace
...
* Export results
export delimited using "output/negative_binomial_burden_v3.csv", replace
