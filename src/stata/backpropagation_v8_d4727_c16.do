* backpropagation - Disease Burden Analysis v8 (d4727)
* Source: World Bank Health Nutrition Population
* Population-level mortality and morbidity analysis

capture log close
log using "results/backpropagation_burden_v8.log", replace
...
* Export results
export delimited using "output/backpropagation_burden_v8.csv", replace
