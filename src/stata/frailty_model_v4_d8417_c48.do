* frailty_model - Disease Burden Analysis v4 (d8417)
* Source: UNICEF MICS
* Population-level mortality and morbidity analysis

capture log close
log using "results/frailty_model_burden_v4.log", replace

* ============================================
* Mortality rate computation
* ============================================
use "data/frailty_model_mortality.dta", clear
...
* Export results
export delimited using "output/frailty_model_burden_v4.csv", replace
