* parametric_survival - Epidemiological Analysis v8 (d820)
* Source: Global Burden of Disease (IHME/GBD)
* Stata 14+ required

capture log close
log using "results/parametric_survival_v8.log", replace
...
graph export "figures/parametric_survival_km_v8.png", replace
