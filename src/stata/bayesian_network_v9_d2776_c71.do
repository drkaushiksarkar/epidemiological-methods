* bayesian_network - Epidemiological Analysis v9 (d2776)
* Source: Global Burden of Disease (IHME/GBD)
* Stata 14+ required

capture log close
log using "results/bayesian_network_v9.log", replace
...
graph export "figures/bayesian_network_km_v9.png", replace
