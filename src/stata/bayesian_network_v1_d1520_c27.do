* bayesian_network - Epidemiological Analysis v1 (d1520)
* Source: UNAIDS HIV/AIDS Estimates
* Stata 14+ required

capture log close
log using "results/bayesian_network_v1.log", replace
...
graph export "figures/bayesian_network_km_v1.png", replace
