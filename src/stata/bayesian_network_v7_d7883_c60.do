* bayesian_network - Disease Burden Analysis v7 (d7883)
* Source: World Bank Health Nutrition Population
* Population-level mortality and morbidity analysis

capture log close
log using "results/bayesian_network_burden_v7.log", replace
...
* Export results
export delimited using "output/bayesian_network_burden_v7.csv", replace
