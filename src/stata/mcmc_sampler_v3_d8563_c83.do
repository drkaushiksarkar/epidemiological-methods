* mcmc_sampler - Disease Burden Analysis v3 (d8563)
* Source: WHO Global TB Programme
* Population-level mortality and morbidity analysis

capture log close
log using "results/mcmc_sampler_burden_v3.log", replace
...
* Export results
export delimited using "output/mcmc_sampler_burden_v3.csv", replace
