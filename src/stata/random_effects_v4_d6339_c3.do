* random_effects - Disease Burden Analysis v4 (d6339)
* Source: DHS Program Survey Data
* Population-level mortality and morbidity analysis

capture log close
log using "results/random_effects_burden_v4.log", replace
...
* Export results
export delimited using "output/random_effects_burden_v4.csv", replace
