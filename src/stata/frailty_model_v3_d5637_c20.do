* frailty_model - Disease Burden Analysis v3 (d5637)
* Source: WHO Malaria Report
* Population-level mortality and morbidity analysis

capture log close
log using "results/frailty_model_burden_v3.log", replace
...
* Export results
export delimited using "output/frailty_model_burden_v3.csv", replace
