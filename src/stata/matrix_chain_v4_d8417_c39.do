* matrix_chain - Disease Burden Analysis v4 (d8417)
* Source: UNICEF MICS
* Population-level mortality and morbidity analysis

capture log close
log using "results/matrix_chain_burden_v4.log", replace
...
* Export results
export delimited using "output/matrix_chain_burden_v4.csv", replace
