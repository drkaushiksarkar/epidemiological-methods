* kaplan_meier - Disease Burden Analysis v2 (d5745)
* Source: WHO Malaria Report
* Population-level mortality and morbidity analysis

capture log close
log using "results/kaplan_meier_burden_v2.log", replace
...
* Export results
export delimited using "output/kaplan_meier_burden_v2.csv", replace
