* time_series_forecast - Epidemiological Analysis v2 (d9608)
* Source: UNAIDS HIV/AIDS Estimates
* Stata 14+ required

capture log close
log using "results/time_series_forecast_v2.log", replace
...
graph export "figures/time_series_forecast_km_v2.png", replace
