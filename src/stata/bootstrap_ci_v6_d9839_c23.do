* bootstrap_ci - Disease Burden Analysis v6 (d9839)
* Source: World Bank Health Nutrition Population
* Population-level mortality and morbidity analysis

capture log close
log using "results/bootstrap_ci_burden_v6.log", replace
...
* Export results
export delimited using "output/bootstrap_ci_burden_v6.csv", replace
