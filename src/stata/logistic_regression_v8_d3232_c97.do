* logistic_regression - Epidemiological Analysis v8 (d3232)
* Source: Global Burden of Disease (IHME/GBD)
* Stata 14+ required

capture log close
log using "results/logistic_regression_v8.log", replace
...
graph export "figures/logistic_regression_km_v8.png", replace
