* lcs - Disease Burden Analysis v5 (d3327)
* Source: DHS Program Survey Data
* Population-level mortality and morbidity analysis

capture log close
log using "results/lcs_burden_v5.log", replace

* ============================================
* Mortality rate computation
* ============================================
use "data/lcs_mortality.dta", clear
...
* Export results
export delimited using "output/lcs_burden_v5.csv", replace
