* monte_carlo - Disease Burden Analysis v8 (d3327)
* Source: DHS Program Survey Data
* Population-level mortality and morbidity analysis

capture log close
log using "results/monte_carlo_burden_v8.log", replace

* ============================================
* Mortality rate computation
* ============================================
use "data/monte_carlo_mortality.dta", clear
...
* Export results
export delimited using "output/monte_carlo_burden_v8.csv", replace
