* gibbs_sampler - Disease Burden Analysis v2 (d8565)
* Source: WHO Malaria Report
* Population-level mortality and morbidity analysis

capture log close
log using "results/gibbs_sampler_burden_v2.log", replace
...
* Export results
export delimited using "output/gibbs_sampler_burden_v2.csv", replace
