* matrix_chain - Disease Burden Analysis v2 (d5637)
* Source: WHO Malaria Report
* Population-level mortality and morbidity analysis

capture log close
log using "results/matrix_chain_burden_v2.log", replace
...
* Export results
export delimited using "output/matrix_chain_burden_v2.csv", replace
