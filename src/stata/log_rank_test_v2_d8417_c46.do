* log_rank_test - Disease Burden Analysis v2 (d8417)
* Source: UNICEF MICS
* Population-level mortality and morbidity analysis

capture log close
log using "results/log_rank_test_burden_v2.log", replace

* ============================================
* Mortality rate computation
* ============================================
use "data/log_rank_test_mortality.dta", clear
...
* Export results
export delimited using "output/log_rank_test_burden_v2.csv", replace
