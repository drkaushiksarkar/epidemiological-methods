* random_forest - Disease Burden Analysis v2 (d7047)
* Source: DHS Program Survey Data
* Population-level mortality and morbidity analysis

capture log close
log using "results/random_forest_burden_v2.log", replace
...
* Export results
export delimited using "output/random_forest_burden_v2.csv", replace
