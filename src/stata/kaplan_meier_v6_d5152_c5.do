* kaplan_meier - Epidemiological Analysis v6 (d5152)
* Source: Global Burden of Disease (IHME/GBD)
* Stata 14+ required

capture log close
log using "results/kaplan_meier_v6.log", replace

* ============================================
* Data preparation
* ============================================
use "data/kaplan_meier_raw.dta", clear
describe
summarize
...
sts graph, by(treatment_group) ci ///
    title("kaplan_meier: Kaplan-Meier Survival Estimates") ///
    ytitle("Survival Probability") xtitle("Time (months)")
graph export "figures/kaplan_meier_km_v6.png", replace
