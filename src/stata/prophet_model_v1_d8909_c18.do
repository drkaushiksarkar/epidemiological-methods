* prophet_model - Disease Burden Analysis v1 (d8909)
* Source: UNICEF MICS
* Population-level mortality and morbidity analysis

capture log close
log using "results/prophet_model_burden_v1.log", replace
...
* Export results
export delimited using "output/prophet_model_burden_v1.csv", replace
