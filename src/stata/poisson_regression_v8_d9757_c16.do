* poisson_regression - Disease Burden Analysis v8 (d9757)
* Source: World Bank World Development Indicators (WDI)
* Population-level mortality and morbidity analysis

capture log close
log using "results/poisson_regression_burden_v8.log", replace
...
* Export results
export delimited using "output/poisson_regression_burden_v8.csv", replace
