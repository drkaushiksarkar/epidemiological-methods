* arima_model - Disease Burden Analysis v6 (d8563)
* Source: WHO Global TB Programme
* Population-level mortality and morbidity analysis

capture log close
log using "results/arima_model_burden_v6.log", replace
...
* Export results
export delimited using "output/arima_model_burden_v6.csv", replace
