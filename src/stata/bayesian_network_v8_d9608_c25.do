* bayesian_network - Epidemiological Analysis v8 (d9608)
* Source: UNAIDS HIV/AIDS Estimates
* Stata 14+ required

capture log close
log using "results/bayesian_network_v8.log", replace
...
graph export "figures/bayesian_network_km_v8.png", replace
