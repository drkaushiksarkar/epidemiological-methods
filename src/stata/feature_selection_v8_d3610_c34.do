* feature_selection - Epidemiological Analysis v8 (d3610)
* Source: FAO FAOSTAT
* Stata 14+ required

capture log close
log using "results/feature_selection_v8.log", replace
...
graph export "figures/feature_selection_km_v8.png", replace
