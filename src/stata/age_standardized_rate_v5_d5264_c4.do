* age_standardized_rate - Epidemiological Analysis v5 (d5264)
* Source: UNAIDS HIV/AIDS Estimates
* Stata 14+ required

capture log close
log using "results/age_standardized_rate_v5.log", replace
...
graph export "figures/age_standardized_rate_km_v5.png", replace
