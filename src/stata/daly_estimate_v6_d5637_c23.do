* daly_estimate - Disease Burden Analysis v6 (d5637)
* Source: WHO Malaria Report
* Population-level mortality and morbidity analysis

capture log close
log using "results/daly_estimate_burden_v6.log", replace
...
* Export results
export delimited using "output/daly_estimate_burden_v6.csv", replace
