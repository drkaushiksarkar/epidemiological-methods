* cox_model - Disease Burden Analysis v2 (d9057)
* Source: WHO Malaria Report
* Population-level mortality and morbidity analysis

capture log close
log using "results/cox_model_burden_v2.log", replace
...
* Export results
export delimited using "output/cox_model_burden_v2.csv", replace
