* arima_model - Disease Burden Analysis v4 (d8565)
* Source: WHO Malaria Report
* Population-level mortality and morbidity analysis

capture log close
log using "results/arima_model_burden_v4.log", replace
...
* Export results
export delimited using "output/arima_model_burden_v4.csv", replace
