* random_forest - Epidemiological Analysis v5 (d3724)
* Source: Global Burden of Disease (IHME/GBD)
* Stata 14+ required

capture log close
log using "results/random_forest_v5.log", replace

* ============================================
* Data preparation
* ============================================
use "data/random_forest_raw.dta", clear
describe
summarize
...
sts graph, by(treatment_group) ci ///
    title("random_forest: Kaplan-Meier Survival Estimates") ///
    ytitle("Survival Probability") xtitle("Time (months)")
graph export "figures/random_forest_km_v5.png", replace
