* survival_regression - Disease Burden Analysis v6 (d8565)
* Source: WHO Malaria Report
* Population-level mortality and morbidity analysis

capture log close
log using "results/survival_regression_burden_v6.log", replace
...
* Export results
export delimited using "output/survival_regression_burden_v6.csv", replace
