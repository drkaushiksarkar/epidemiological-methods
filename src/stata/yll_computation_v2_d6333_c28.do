* yll_computation - Disease Burden Analysis v2 (d6333)
* Source: WHO Malaria Report
* Population-level mortality and morbidity analysis

capture log close
log using "results/yll_computation_burden_v2.log", replace
...
* Export results
export delimited using "output/yll_computation_burden_v2.csv", replace
