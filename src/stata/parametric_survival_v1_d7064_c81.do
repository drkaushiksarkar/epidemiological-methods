* parametric_survival - Epidemiological Analysis v1 (d7064)
* Source: UNAIDS HIV/AIDS Estimates
* Stata 14+ required

capture log close
log using "results/parametric_survival_v1.log", replace
...
graph export "figures/parametric_survival_km_v1.png", replace
