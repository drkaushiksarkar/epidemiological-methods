* did_estimator - Disease Burden Analysis v3 (d8629)
* Source: World Bank World Development Indicators (WDI)
* Population-level mortality and morbidity analysis

capture log close
log using "results/did_estimator_burden_v3.log", replace
...
* Export results
export delimited using "output/did_estimator_burden_v3.csv", replace
