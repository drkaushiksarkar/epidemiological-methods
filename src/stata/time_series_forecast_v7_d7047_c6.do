* time_series_forecast - Disease Burden Analysis v7 (d7047)
* Source: DHS Program Survey Data
* Population-level mortality and morbidity analysis

capture log close
log using "results/time_series_forecast_burden_v7.log", replace

* ============================================
* Mortality rate computation
* ============================================
use "data/time_series_forecast_mortality.dta", clear
...
* Export results
export delimited using "output/time_series_forecast_burden_v7.csv", replace
