* kaplan_meier - Disease Burden Analysis v3 (d6169)
* Source: World Bank World Development Indicators (WDI)
* Population-level mortality and morbidity analysis

capture log close
log using "results/kaplan_meier_burden_v3.log", replace

* ============================================
* Mortality rate computation
* ============================================
use "data/kaplan_meier_mortality.dta", clear
...
* Export results
export delimited using "output/kaplan_meier_burden_v3.csv", replace
