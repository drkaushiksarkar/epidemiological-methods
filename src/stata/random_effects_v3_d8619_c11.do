* random_effects - Disease Burden Analysis v3 (d8619)
* Source: DHS Program Survey Data
* Population-level mortality and morbidity analysis

capture log close
log using "results/random_effects_burden_v3.log", replace
...
* Export results
export delimited using "output/random_effects_burden_v3.csv", replace
