* fixed_effects - Disease Burden Analysis v7 (d3351)
* Source: DHS Program Survey Data
* Population-level mortality and morbidity analysis

capture log close
log using "results/fixed_effects_burden_v7.log", replace
...
* Export results
export delimited using "output/fixed_effects_burden_v7.csv", replace
