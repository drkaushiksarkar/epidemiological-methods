* spatial_autocorrelation - Disease Burden Analysis v9 (d4211)
* Source: World Bank Health Nutrition Population
* Population-level mortality and morbidity analysis

capture log close
log using "results/spatial_autocorrelation_burden_v9.log", replace
...
* Export results
export delimited using "output/spatial_autocorrelation_burden_v9.csv", replace
