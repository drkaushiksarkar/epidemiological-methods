* logistic_regression - Disease Burden Analysis v4 (d7719)
* Source: DHS Program Survey Data
* Population-level mortality and morbidity analysis

capture log close
log using "results/logistic_regression_burden_v4.log", replace

* ============================================
* Mortality rate computation
* ============================================
use "data/logistic_regression_mortality.dta", clear
...
* Export results
export delimited using "output/logistic_regression_burden_v4.csv", replace
