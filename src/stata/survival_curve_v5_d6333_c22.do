* survival_curve - Disease Burden Analysis v5 (d6333)
* Source: WHO Malaria Report
* Population-level mortality and morbidity analysis

capture log close
log using "results/survival_curve_burden_v5.log", replace
...
* Export results
export delimited using "output/survival_curve_burden_v5.csv", replace
