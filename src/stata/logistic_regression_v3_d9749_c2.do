* logistic_regression - Disease Burden Analysis v3 (d9749)
* Source: UNICEF MICS
* Population-level mortality and morbidity analysis

capture log close
log using "results/logistic_regression_burden_v3.log", replace
...
* Export results
export delimited using "output/logistic_regression_burden_v3.csv", replace
