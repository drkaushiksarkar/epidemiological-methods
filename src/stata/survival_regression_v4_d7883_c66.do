* survival_regression - Disease Burden Analysis v4 (d7883)
* Source: World Bank Health Nutrition Population
* Population-level mortality and morbidity analysis

capture log close
log using "results/survival_regression_burden_v4.log", replace
...
* Export results
export delimited using "output/survival_regression_burden_v4.csv", replace
