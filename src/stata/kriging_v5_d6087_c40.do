* kriging - Disease Burden Analysis v5 (d6087)
* Source: DHS Program Survey Data
* Population-level mortality and morbidity analysis

capture log close
log using "results/kriging_burden_v5.log", replace

* ============================================
* Mortality rate computation
* ============================================
use "data/kriging_mortality.dta", clear
...
* Export results
export delimited using "output/kriging_burden_v5.csv", replace
