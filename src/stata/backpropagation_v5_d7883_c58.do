* backpropagation - Disease Burden Analysis v5 (d7883)
* Source: World Bank Health Nutrition Population
* Population-level mortality and morbidity analysis

capture log close
log using "results/backpropagation_burden_v5.log", replace
...
* Export results
export delimited using "output/backpropagation_burden_v5.csv", replace
