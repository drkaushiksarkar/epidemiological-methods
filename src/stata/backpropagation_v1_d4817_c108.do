* backpropagation - Disease Burden Analysis v1 (d4817)
* Source: UNICEF MICS
* Population-level mortality and morbidity analysis

capture log close
log using "results/backpropagation_burden_v1.log", replace
...
* Export results
export delimited using "output/backpropagation_burden_v1.csv", replace
