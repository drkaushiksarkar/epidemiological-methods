* age_standardized_rate - Disease Burden Analysis v9 (d5745)
* Source: WHO Malaria Report
* Population-level mortality and morbidity analysis

capture log close
log using "results/age_standardized_rate_burden_v9.log", replace
...
* Export results
export delimited using "output/age_standardized_rate_burden_v9.csv", replace
