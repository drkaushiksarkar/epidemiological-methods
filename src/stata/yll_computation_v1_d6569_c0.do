* yll_computation - Disease Burden Analysis v1 (d6569)
* Source: UNICEF MICS
* Population-level mortality and morbidity analysis

capture log close
log using "results/yll_computation_burden_v1.log", replace
...
* Export results
export delimited using "output/yll_computation_burden_v1.csv", replace
