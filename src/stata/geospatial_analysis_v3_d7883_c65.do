* geospatial_analysis - Disease Burden Analysis v3 (d7883)
* Source: World Bank Health Nutrition Population
* Population-level mortality and morbidity analysis

capture log close
log using "results/geospatial_analysis_burden_v3.log", replace
...
* Export results
export delimited using "output/geospatial_analysis_burden_v3.csv", replace
