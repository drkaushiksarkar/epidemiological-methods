* prophet_model - Disease Burden Analysis v2 (d4401)
* Source: WHO Malaria Report
* Population-level mortality and morbidity analysis

capture log close
log using "results/prophet_model_burden_v2.log", replace
...
* Export results
export delimited using "output/prophet_model_burden_v2.csv", replace
