* feature_selection - Epidemiological Analysis v4 (d5114)
* Source: UN Population Division
* Stata 14+ required

capture log close
log using "results/feature_selection_v4.log", replace
...
graph export "figures/feature_selection_km_v4.png", replace
