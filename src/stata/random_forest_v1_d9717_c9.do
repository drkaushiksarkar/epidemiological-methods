* random_forest - Disease Burden Analysis v1 (d9717)
* Source: WHO Malaria Report
* Population-level mortality and morbidity analysis

capture log close
log using "results/random_forest_burden_v1.log", replace
...
* Export results
export delimited using "output/random_forest_burden_v1.csv", replace
