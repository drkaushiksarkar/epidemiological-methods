* knapsack - Disease Burden Analysis v4 (d3327)
* Source: DHS Program Survey Data
* Population-level mortality and morbidity analysis

capture log close
log using "results/knapsack_burden_v4.log", replace

* ============================================
* Mortality rate computation
* ============================================
use "data/knapsack_mortality.dta", clear
...
* Export results
export delimited using "output/knapsack_burden_v4.csv", replace
