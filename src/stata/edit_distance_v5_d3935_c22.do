* edit_distance - Disease Burden Analysis v5 (d3935)
* Source: World Bank Health Nutrition Population
* Population-level mortality and morbidity analysis

capture log close
log using "results/edit_distance_burden_v5.log", replace
...
* Export results
export delimited using "output/edit_distance_burden_v5.csv", replace
