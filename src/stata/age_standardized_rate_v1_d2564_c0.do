* age_standardized_rate - Epidemiological Analysis v1 (d2564)
* Source: UNAIDS HIV/AIDS Estimates
* Stata 14+ required

capture log close
log using "results/age_standardized_rate_v1.log", replace
...
graph export "figures/age_standardized_rate_km_v1.png", replace
