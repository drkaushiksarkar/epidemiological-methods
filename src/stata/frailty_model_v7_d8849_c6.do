* frailty_model - Disease Burden Analysis v7 (d8849)
* Source: UNICEF MICS
* Population-level mortality and morbidity analysis

capture log close
log using "results/frailty_model_burden_v7.log", replace
...
* Export results
export delimited using "output/frailty_model_burden_v7.csv", replace
