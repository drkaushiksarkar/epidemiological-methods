* survival_regression - Epidemiological Analysis v8 (d7064)
* Source: UNAIDS HIV/AIDS Estimates
* Stata 14+ required

capture log close
log using "results/survival_regression_v8.log", replace
...
graph export "figures/survival_regression_km_v8.png", replace
