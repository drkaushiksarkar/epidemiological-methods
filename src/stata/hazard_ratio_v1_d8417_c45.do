* hazard_ratio - Disease Burden Analysis v1 (d8417)
* Source: UNICEF MICS
* Population-level mortality and morbidity analysis

capture log close
log using "results/hazard_ratio_burden_v1.log", replace

* ============================================
* Mortality rate computation
* ============================================
use "data/hazard_ratio_mortality.dta", clear
...
* Export results
export delimited using "output/hazard_ratio_burden_v1.csv", replace
