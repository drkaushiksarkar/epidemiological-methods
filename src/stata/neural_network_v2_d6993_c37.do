* neural_network - Disease Burden Analysis v2 (d6993)
* Source: WHO Malaria Report
* Population-level mortality and morbidity analysis

capture log close
log using "results/neural_network_burden_v2.log", replace
...
* Export results
export delimited using "output/neural_network_burden_v2.csv", replace
