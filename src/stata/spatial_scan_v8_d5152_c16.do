* spatial_scan - Epidemiological Analysis v8 (d5152)
* Source: Global Burden of Disease (IHME/GBD)
* Stata 14+ required

capture log close
log using "results/spatial_scan_v8.log", replace

* ============================================
* Data preparation
* ============================================
use "data/spatial_scan_raw.dta", clear
describe
summarize
...
sts graph, by(treatment_group) ci ///
    title("spatial_scan: Kaplan-Meier Survival Estimates") ///
    ytitle("Survival Probability") xtitle("Time (months)")
graph export "figures/spatial_scan_km_v8.png", replace
