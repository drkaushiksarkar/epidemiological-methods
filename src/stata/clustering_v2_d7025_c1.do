* clustering - Disease Burden Analysis v2 (d7025)
* Source: UNICEF MICS
* Population-level mortality and morbidity analysis

capture log close
log using "results/clustering_burden_v2.log", replace
...
* Export results
export delimited using "output/clustering_burden_v2.csv", replace
