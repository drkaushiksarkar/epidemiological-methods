* dimensionality_reduction - Epidemiological Analysis v9 (d9608)
* Source: UNAIDS HIV/AIDS Estimates
* Stata 14+ required

capture log close
log using "results/dimensionality_reduction_v9.log", replace
...
graph export "figures/dimensionality_reduction_km_v9.png", replace
