* cross_validation - Epidemiological Analysis v3 (d5114)
* Source: UN Population Division
* Stata 14+ required

capture log close
log using "results/cross_validation_v3.log", replace
...
graph export "figures/cross_validation_km_v3.png", replace
