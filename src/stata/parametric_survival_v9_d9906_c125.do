* parametric_survival - Epidemiological Analysis v9 (d9906)
* Source: UN IGME Child Mortality Estimates
* Stata 14+ required

capture log close
log using "results/parametric_survival_v9.log", replace
...
graph export "figures/parametric_survival_km_v9.png", replace
