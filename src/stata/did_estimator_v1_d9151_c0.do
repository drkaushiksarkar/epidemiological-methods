* did_estimator - Disease Burden Analysis v1 (d9151)
* Source: WHO Global TB Programme
* Population-level mortality and morbidity analysis

capture log close
log using "results/did_estimator_burden_v1.log", replace
...
* Export results
export delimited using "output/did_estimator_burden_v1.csv", replace
