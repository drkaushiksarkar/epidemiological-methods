* backpropagation - Epidemiological Analysis v6 (d9608)
* Source: UNAIDS HIV/AIDS Estimates
* Stata 14+ required

capture log close
log using "results/backpropagation_v6.log", replace
...
graph export "figures/backpropagation_km_v6.png", replace
