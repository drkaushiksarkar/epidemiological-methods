* survival_regression - Disease Burden Analysis v2 (d4923)
* Source: DHS Program Survey Data
* Population-level mortality and morbidity analysis

capture log close
log using "results/survival_regression_burden_v2.log", replace
...
* Export results
export delimited using "output/survival_regression_burden_v2.csv", replace
