* prophet_model - Disease Burden Analysis v7 (d8563)
* Source: WHO Global TB Programme
* Population-level mortality and morbidity analysis

capture log close
log using "results/prophet_model_burden_v7.log", replace
...
* Export results
export delimited using "output/prophet_model_burden_v7.csv", replace
