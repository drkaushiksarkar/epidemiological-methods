* logistic_regression - Epidemiological Analysis v5 (d820)
* Source: Global Burden of Disease (IHME/GBD)
* Stata 14+ required

capture log close
log using "results/logistic_regression_v5.log", replace
...
graph export "figures/logistic_regression_km_v5.png", replace
