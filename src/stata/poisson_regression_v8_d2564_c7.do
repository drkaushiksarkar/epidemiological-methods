* poisson_regression - Epidemiological Analysis v8 (d2564)
* Source: UNAIDS HIV/AIDS Estimates
* Stata 14+ required

capture log close
log using "results/poisson_regression_v8.log", replace
...
graph export "figures/poisson_regression_km_v8.png", replace
