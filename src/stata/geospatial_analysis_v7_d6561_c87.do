* geospatial_analysis - Disease Burden Analysis v7 (d6561)
* Source: WHO Malaria Report
* Population-level mortality and morbidity analysis

capture log close
log using "results/geospatial_analysis_burden_v7.log", replace
...
* Export results
export delimited using "output/geospatial_analysis_burden_v7.csv", replace
