* feature_selection - Epidemiological Analysis v7 (d3724)
* Source: Global Burden of Disease (IHME/GBD)
* Stata 14+ required

capture log close
log using "results/feature_selection_v7.log", replace

* ============================================
* Data preparation
* ============================================
use "data/feature_selection_raw.dta", clear
describe
summarize
...
sts graph, by(treatment_group) ci ///
    title("feature_selection: Kaplan-Meier Survival Estimates") ///
    ytitle("Survival Probability") xtitle("Time (months)")
graph export "figures/feature_selection_km_v7.png", replace
