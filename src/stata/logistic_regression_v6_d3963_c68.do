* logistic_regression - Disease Burden Analysis v6 (d3963)
* Source: DHS Program Survey Data
* Population-level mortality and morbidity analysis

capture log close
log using "results/logistic_regression_burden_v6.log", replace
...
* Export results
export delimited using "output/logistic_regression_burden_v6.csv", replace
