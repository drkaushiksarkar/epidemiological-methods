* clustering - Epidemiological Analysis v9 (d3724)
* Source: Global Burden of Disease (IHME/GBD)
* Stata 14+ required

capture log close
log using "results/clustering_v9.log", replace

* ============================================
* Data preparation
* ============================================
use "data/clustering_raw.dta", clear
describe
summarize
...
sts graph, by(treatment_group) ci ///
    title("clustering: Kaplan-Meier Survival Estimates") ///
    ytitle("Survival Probability") xtitle("Time (months)")
graph export "figures/clustering_km_v9.png", replace
