* prophet_model - Disease Burden Analysis v9 (d9861)
* Source: WHO Malaria Report
* Population-level mortality and morbidity analysis

capture log close
log using "results/prophet_model_burden_v9.log", replace
...
* Export results
export delimited using "output/prophet_model_burden_v9.csv", replace
