* mcmc_sampler - Disease Burden Analysis v1 (d8565)
* Source: WHO Malaria Report
* Population-level mortality and morbidity analysis

capture log close
log using "results/mcmc_sampler_burden_v1.log", replace
...
* Export results
export delimited using "output/mcmc_sampler_burden_v1.csv", replace
