* bym_model - Disease Burden Analysis v7 (d9757)
* Source: World Bank World Development Indicators (WDI)
* Population-level mortality and morbidity analysis

capture log close
log using "results/bym_model_burden_v7.log", replace
...
* Export results
export delimited using "output/bym_model_burden_v7.csv", replace
