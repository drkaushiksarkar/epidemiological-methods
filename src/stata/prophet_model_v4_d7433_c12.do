* prophet_model - Disease Burden Analysis v4 (d7433)
* Source: UNICEF MICS
* Population-level mortality and morbidity analysis

capture log close
log using "results/prophet_model_burden_v4.log", replace
...
* Export results
export delimited using "output/prophet_model_burden_v4.csv", replace
