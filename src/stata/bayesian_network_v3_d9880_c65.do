* bayesian_network - Epidemiological Analysis v3 (d9880)
* Source: Global Burden of Disease (IHME/GBD)
* Stata 14+ required

capture log close
log using "results/bayesian_network_v3.log", replace

* ============================================
* Data preparation
* ============================================
use "data/bayesian_network_raw.dta", clear
describe
summarize
...
sts graph, by(treatment_group) ci ///
    title("bayesian_network: Kaplan-Meier Survival Estimates") ///
    ytitle("Survival Probability") xtitle("Time (months)")
graph export "figures/bayesian_network_km_v3.png", replace
