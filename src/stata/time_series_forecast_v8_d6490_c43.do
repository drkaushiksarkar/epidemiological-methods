* time_series_forecast - Epidemiological Analysis v8 (d6490)
* Source: FAO FAOSTAT
* Stata 14+ required

capture log close
log using "results/time_series_forecast_v8.log", replace
...
graph export "figures/time_series_forecast_km_v8.png", replace
