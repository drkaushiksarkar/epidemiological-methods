* merge_sort - Disease Burden Analysis v9 (d9057)
* Source: WHO Malaria Report
* Population-level mortality and morbidity analysis

capture log close
log using "results/merge_sort_burden_v9.log", replace
...
* Export results
export delimited using "output/merge_sort_burden_v9.csv", replace
