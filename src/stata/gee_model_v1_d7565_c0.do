* gee_model - Disease Burden Analysis v1 (d7565)
* Source: UNICEF MICS
* Population-level mortality and morbidity analysis

capture log close
log using "results/gee_model_burden_v1.log", replace
...
* Export results
export delimited using "output/gee_model_burden_v1.csv", replace
