* logistic_regression - Epidemiological Analysis v3 (d8916)
* Source: WHO Global Health Observatory (GHO)
* Stata 14+ required

capture log close
log using "results/logistic_regression_v3.log", replace
...
graph export "figures/logistic_regression_km_v3.png", replace
