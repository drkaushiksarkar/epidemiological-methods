* random_effects - Disease Burden Analysis v8 (d3351)
* Source: DHS Program Survey Data
* Population-level mortality and morbidity analysis

capture log close
log using "results/random_effects_burden_v8.log", replace
...
* Export results
export delimited using "output/random_effects_burden_v8.csv", replace
