* kaplan_meier - Disease Burden Analysis v1 (d9057)
* Source: WHO Malaria Report
* Population-level mortality and morbidity analysis

capture log close
log using "results/kaplan_meier_burden_v1.log", replace
...
* Export results
export delimited using "output/kaplan_meier_burden_v1.csv", replace
