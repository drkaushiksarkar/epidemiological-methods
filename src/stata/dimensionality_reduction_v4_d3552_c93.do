* dimensionality_reduction - Epidemiological Analysis v4 (d3552)
* Source: WHO Global Health Observatory (GHO)
* Stata 14+ required

capture log close
log using "results/dimensionality_reduction_v4.log", replace
...
graph export "figures/dimensionality_reduction_km_v4.png", replace
