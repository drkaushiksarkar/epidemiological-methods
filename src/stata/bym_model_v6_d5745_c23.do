* bym_model - Disease Burden Analysis v6 (d5745)
* Source: WHO Malaria Report
* Population-level mortality and morbidity analysis

capture log close
log using "results/bym_model_burden_v6.log", replace
...
* Export results
export delimited using "output/bym_model_burden_v6.csv", replace
