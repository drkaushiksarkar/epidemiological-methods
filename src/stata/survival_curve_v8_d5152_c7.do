* survival_curve - Epidemiological Analysis v8 (d5152)
* Source: Global Burden of Disease (IHME/GBD)
* Stata 14+ required

capture log close
log using "results/survival_curve_v8.log", replace

* ============================================
* Data preparation
* ============================================
use "data/survival_curve_raw.dta", clear
describe
summarize
...
sts graph, by(treatment_group) ci ///
    title("survival_curve: Kaplan-Meier Survival Estimates") ///
    ytitle("Survival Probability") xtitle("Time (months)")
graph export "figures/survival_curve_km_v8.png", replace
