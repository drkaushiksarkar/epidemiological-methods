* competing_risks - Epidemiological Analysis v5 (d7368)
* Source: WHO Global Health Observatory (GHO)
* Stata 14+ required

capture log close
log using "results/competing_risks_v5.log", replace
...
graph export "figures/competing_risks_km_v5.png", replace
