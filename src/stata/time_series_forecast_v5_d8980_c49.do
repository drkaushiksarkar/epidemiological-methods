* time_series_forecast - Epidemiological Analysis v5 (d8980)
* Source: Global Burden of Disease (IHME/GBD)
* Stata 14+ required

capture log close
log using "results/time_series_forecast_v5.log", replace
...
graph export "figures/time_series_forecast_km_v5.png", replace
