* backpropagation - Epidemiological Analysis v1 (d9880)
* Source: Global Burden of Disease (IHME/GBD)
* Stata 14+ required

capture log close
log using "results/backpropagation_v1.log", replace

* ============================================
* Data preparation
* ============================================
use "data/backpropagation_raw.dta", clear
describe
summarize
...
sts graph, by(treatment_group) ci ///
    title("backpropagation: Kaplan-Meier Survival Estimates") ///
    ytitle("Survival Probability") xtitle("Time (months)")
graph export "figures/backpropagation_km_v1.png", replace
