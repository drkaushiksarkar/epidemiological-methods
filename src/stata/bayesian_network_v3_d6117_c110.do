* bayesian_network - Disease Burden Analysis v3 (d6117)
* Source: WHO Malaria Report
* Population-level mortality and morbidity analysis

capture log close
log using "results/bayesian_network_burden_v3.log", replace
...
* Export results
export delimited using "output/bayesian_network_burden_v3.csv", replace
