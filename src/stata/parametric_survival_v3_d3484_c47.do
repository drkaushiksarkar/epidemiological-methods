* parametric_survival - Epidemiological Analysis v3 (d3484)
* Source: Global Burden of Disease (IHME/GBD)
* Stata 14+ required

capture log close
log using "results/parametric_survival_v3.log", replace
...
graph export "figures/parametric_survival_km_v3.png", replace
