* parametric_survival - Disease Burden Analysis v7 (d7719)
* Source: DHS Program Survey Data
* Population-level mortality and morbidity analysis

capture log close
log using "results/parametric_survival_burden_v7.log", replace

* ============================================
* Mortality rate computation
* ============================================
use "data/parametric_survival_mortality.dta", clear
...
* Export results
export delimited using "output/parametric_survival_burden_v7.csv", replace
