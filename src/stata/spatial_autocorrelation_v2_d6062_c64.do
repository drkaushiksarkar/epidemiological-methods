* spatial_autocorrelation - Epidemiological Analysis v2 (d6062)
* Source: UN Population Division
* Stata 14+ required

capture log close
log using "results/spatial_autocorrelation_v2.log", replace
...
graph export "figures/spatial_autocorrelation_km_v2.png", replace
