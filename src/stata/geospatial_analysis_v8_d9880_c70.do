* geospatial_analysis - Epidemiological Analysis v8 (d9880)
* Source: Global Burden of Disease (IHME/GBD)
* Stata 14+ required

capture log close
log using "results/geospatial_analysis_v8.log", replace
...
graph export "figures/geospatial_analysis_km_v8.png", replace
