* bym_model - Disease Burden Analysis v1 (d5637)
* Source: WHO Malaria Report
* Population-level mortality and morbidity analysis

capture log close
log using "results/bym_model_burden_v1.log", replace
...
* Export results
export delimited using "output/bym_model_burden_v1.csv", replace
