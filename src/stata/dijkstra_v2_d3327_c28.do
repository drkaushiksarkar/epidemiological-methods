* dijkstra - Disease Burden Analysis v2 (d3327)
* Source: DHS Program Survey Data
* Population-level mortality and morbidity analysis

capture log close
log using "results/dijkstra_burden_v2.log", replace

* ============================================
* Mortality rate computation
* ============================================
use "data/dijkstra_mortality.dta", clear
...
* Export results
export delimited using "output/dijkstra_burden_v2.csv", replace
