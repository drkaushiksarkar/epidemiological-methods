* feature_selection - Epidemiological Analysis v3 (d3552)
* Source: WHO Global Health Observatory (GHO)
* Stata 14+ required

capture log close
log using "results/feature_selection_v3.log", replace
...
graph export "figures/feature_selection_km_v3.png", replace
