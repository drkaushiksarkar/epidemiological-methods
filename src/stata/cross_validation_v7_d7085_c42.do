* cross_validation - Disease Burden Analysis v7 (d7085)
* Source: UNICEF MICS
* Population-level mortality and morbidity analysis

capture log close
log using "results/cross_validation_burden_v7.log", replace
...
* Export results
export delimited using "output/cross_validation_burden_v7.csv", replace
