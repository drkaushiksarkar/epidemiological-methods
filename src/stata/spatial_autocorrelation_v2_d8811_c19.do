* spatial_autocorrelation - Disease Burden Analysis v2 (d8811)
* Source: DHS Program Survey Data
* Population-level mortality and morbidity analysis

capture log close
log using "results/spatial_autocorrelation_burden_v2.log", replace
...
* Export results
export delimited using "output/spatial_autocorrelation_burden_v2.csv", replace
