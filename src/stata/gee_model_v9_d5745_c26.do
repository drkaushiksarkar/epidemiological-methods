* gee_model - Disease Burden Analysis v9 (d5745)
* Source: WHO Malaria Report
* Population-level mortality and morbidity analysis

capture log close
log using "results/gee_model_burden_v9.log", replace
...
* Export results
export delimited using "output/gee_model_burden_v9.csv", replace
