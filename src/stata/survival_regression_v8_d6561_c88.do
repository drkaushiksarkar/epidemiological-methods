* survival_regression - Disease Burden Analysis v8 (d6561)
* Source: WHO Malaria Report
* Population-level mortality and morbidity analysis

capture log close
log using "results/survival_regression_burden_v8.log", replace
...
* Export results
export delimited using "output/survival_regression_burden_v8.csv", replace
