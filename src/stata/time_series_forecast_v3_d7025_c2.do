* time_series_forecast - Disease Burden Analysis v3 (d7025)
* Source: UNICEF MICS
* Population-level mortality and morbidity analysis

capture log close
log using "results/time_series_forecast_burden_v3.log", replace
...
* Export results
export delimited using "output/time_series_forecast_burden_v3.csv", replace
