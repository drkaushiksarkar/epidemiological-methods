* clustering - Disease Burden Analysis v1 (d7433)
* Source: UNICEF MICS
* Population-level mortality and morbidity analysis

capture log close
log using "results/clustering_burden_v1.log", replace
...
* Export results
export delimited using "output/clustering_burden_v1.csv", replace
