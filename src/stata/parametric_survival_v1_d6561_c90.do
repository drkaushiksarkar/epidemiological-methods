* parametric_survival - Disease Burden Analysis v1 (d6561)
* Source: WHO Malaria Report
* Population-level mortality and morbidity analysis

capture log close
log using "results/parametric_survival_burden_v1.log", replace
...
* Export results
export delimited using "output/parametric_survival_burden_v1.csv", replace
