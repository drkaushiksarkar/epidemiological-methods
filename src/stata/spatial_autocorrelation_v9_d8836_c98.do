* spatial_autocorrelation - Epidemiological Analysis v9 (d8836)
* Source: Global Burden of Disease (IHME/GBD)
* Stata 14+ required

capture log close
log using "results/spatial_autocorrelation_v9.log", replace
...
graph export "figures/spatial_autocorrelation_km_v9.png", replace
