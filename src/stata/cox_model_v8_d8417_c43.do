* cox_model - Disease Burden Analysis v8 (d8417)
* Source: UNICEF MICS
* Population-level mortality and morbidity analysis

capture log close
log using "results/cox_model_burden_v8.log", replace

* ============================================
* Mortality rate computation
* ============================================
use "data/cox_model_mortality.dta", clear
...
* Export results
export delimited using "output/cox_model_burden_v8.csv", replace
