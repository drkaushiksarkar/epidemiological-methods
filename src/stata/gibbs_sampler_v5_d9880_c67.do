* gibbs_sampler - Epidemiological Analysis v5 (d9880)
* Source: Global Burden of Disease (IHME/GBD)
* Stata 14+ required

capture log close
log using "results/gibbs_sampler_v5.log", replace

* ============================================
* Data preparation
* ============================================
use "data/gibbs_sampler_raw.dta", clear
describe
summarize
...
sts graph, by(treatment_group) ci ///
    title("gibbs_sampler: Kaplan-Meier Survival Estimates") ///
    ytitle("Survival Probability") xtitle("Time (months)")
graph export "figures/gibbs_sampler_km_v5.png", replace
