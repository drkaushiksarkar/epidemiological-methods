* neural_network - Disease Burden Analysis v3 (d4401)
* Source: WHO Malaria Report
* Population-level mortality and morbidity analysis

capture log close
log using "results/neural_network_burden_v3.log", replace
...
* Export results
export delimited using "output/neural_network_burden_v3.csv", replace
