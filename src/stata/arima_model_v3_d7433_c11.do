* arima_model - Disease Burden Analysis v3 (d7433)
* Source: UNICEF MICS
* Population-level mortality and morbidity analysis

capture log close
log using "results/arima_model_burden_v3.log", replace
...
* Export results
export delimited using "output/arima_model_burden_v3.csv", replace
