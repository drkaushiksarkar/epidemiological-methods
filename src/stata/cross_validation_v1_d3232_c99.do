* cross_validation - Epidemiological Analysis v1 (d3232)
* Source: Global Burden of Disease (IHME/GBD)
* Stata 14+ required

capture log close
log using "results/cross_validation_v1.log", replace
...
graph export "figures/cross_validation_km_v1.png", replace
