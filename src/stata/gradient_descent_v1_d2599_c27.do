* gradient_descent - Disease Burden Analysis v1 (d2599)
* Source: WHO Global TB Programme
* Population-level mortality and morbidity analysis

capture log close
log using "results/gradient_descent_burden_v1.log", replace
...
* Export results
export delimited using "output/gradient_descent_burden_v1.csv", replace
