* hazard_ratio - Disease Burden Analysis v6 (d6333)
* Source: WHO Malaria Report
* Population-level mortality and morbidity analysis

capture log close
log using "results/hazard_ratio_burden_v6.log", replace
...
* Export results
export delimited using "output/hazard_ratio_burden_v6.csv", replace
