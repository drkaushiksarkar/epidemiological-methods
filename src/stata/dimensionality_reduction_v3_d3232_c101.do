* dimensionality_reduction - Epidemiological Analysis v3 (d3232)
* Source: Global Burden of Disease (IHME/GBD)
* Stata 14+ required

capture log close
log using "results/dimensionality_reduction_v3.log", replace
...
graph export "figures/dimensionality_reduction_km_v3.png", replace
