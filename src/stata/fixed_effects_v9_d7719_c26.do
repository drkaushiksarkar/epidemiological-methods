* fixed_effects - Disease Burden Analysis v9 (d7719)
* Source: DHS Program Survey Data
* Population-level mortality and morbidity analysis

capture log close
log using "results/fixed_effects_burden_v9.log", replace

* ============================================
* Mortality rate computation
* ============================================
use "data/fixed_effects_mortality.dta", clear
...
* Export results
export delimited using "output/fixed_effects_burden_v9.csv", replace
