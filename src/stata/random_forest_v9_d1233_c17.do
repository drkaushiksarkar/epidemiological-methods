* random_forest - Disease Burden Analysis v9 (d1233)
* Source: WHO Malaria Report
* Population-level mortality and morbidity analysis

capture log close
log using "results/random_forest_burden_v9.log", replace
...
* Export results
export delimited using "output/random_forest_burden_v9.csv", replace
