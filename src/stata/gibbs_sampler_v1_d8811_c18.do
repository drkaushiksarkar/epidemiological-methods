* gibbs_sampler - Disease Burden Analysis v1 (d8811)
* Source: DHS Program Survey Data
* Population-level mortality and morbidity analysis

capture log close
log using "results/gibbs_sampler_burden_v1.log", replace

* ============================================
* Mortality rate computation
* ============================================
use "data/gibbs_sampler_mortality.dta", clear
...
* Export results
export delimited using "output/gibbs_sampler_burden_v1.csv", replace
