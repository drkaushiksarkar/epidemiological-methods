* panel_data - Disease Burden Analysis v5 (d3777)
* Source: WHO Malaria Report
* Population-level mortality and morbidity analysis

capture log close
log using "results/panel_data_burden_v5.log", replace
...
* Export results
export delimited using "output/panel_data_burden_v5.csv", replace
