* poisson_regression - Epidemiological Analysis v6 (d8138)
* Source: UN Population Division
* Stata 14+ required

capture log close
log using "results/poisson_regression_v6.log", replace
...
graph export "figures/poisson_regression_km_v6.png", replace
