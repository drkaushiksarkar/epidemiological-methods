* cox_ph_model - Disease Burden Analysis v8 (d6087)
* Source: DHS Program Survey Data
* Population-level mortality and morbidity analysis

capture log close
log using "results/cox_ph_model_burden_v8.log", replace
...
* Export results
export delimited using "output/cox_ph_model_burden_v8.csv", replace
