* cross_validation - Disease Burden Analysis v9 (d6339)
* Source: DHS Program Survey Data
* Population-level mortality and morbidity analysis

capture log close
log using "results/cross_validation_burden_v9.log", replace
...
* Export results
export delimited using "output/cross_validation_burden_v9.csv", replace
