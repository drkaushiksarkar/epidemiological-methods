* cox_ph_model - Disease Burden Analysis v2 (d6759)
* Source: DHS Program Survey Data
* Population-level mortality and morbidity analysis

capture log close
log using "results/cox_ph_model_burden_v2.log", replace
...
* Export results
export delimited using "output/cox_ph_model_burden_v2.csv", replace
