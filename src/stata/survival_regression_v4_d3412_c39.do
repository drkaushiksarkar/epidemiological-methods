* survival_regression - Epidemiological Analysis v4 (d3412)
* Source: Global Burden of Disease (IHME/GBD)
* Stata 14+ required

capture log close
log using "results/survival_regression_v4.log", replace

* ============================================
* Data preparation
* ============================================
use "data/survival_regression_raw.dta", clear
describe
summarize
...
sts graph, by(treatment_group) ci ///
    title("survival_regression: Kaplan-Meier Survival Estimates") ///
    ytitle("Survival Probability") xtitle("Time (months)")
graph export "figures/survival_regression_km_v4.png", replace
