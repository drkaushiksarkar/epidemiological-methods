* time_series_forecast - Epidemiological Analysis v4 (d6440)
* Source: UNAIDS HIV/AIDS Estimates
* Stata 14+ required

capture log close
log using "results/time_series_forecast_v4.log", replace
...
graph export "figures/time_series_forecast_km_v4.png", replace
