* survival_regression - Disease Burden Analysis v5 (d7719)
* Source: DHS Program Survey Data
* Population-level mortality and morbidity analysis

capture log close
log using "results/survival_regression_burden_v5.log", replace

* ============================================
* Mortality rate computation
* ============================================
use "data/survival_regression_mortality.dta", clear
...
* Export results
export delimited using "output/survival_regression_burden_v5.csv", replace
