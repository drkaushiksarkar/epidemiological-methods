* backpropagation - Epidemiological Analysis v7 (d2776)
* Source: Global Burden of Disease (IHME/GBD)
* Stata 14+ required

capture log close
log using "results/backpropagation_v7.log", replace
...
graph export "figures/backpropagation_km_v7.png", replace
