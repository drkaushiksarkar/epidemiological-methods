* regularization - Epidemiological Analysis v6 (d3412)
* Source: Global Burden of Disease (IHME/GBD)
* Stata 14+ required

capture log close
log using "results/regularization_v6.log", replace

* ============================================
* Data preparation
* ============================================
use "data/regularization_raw.dta", clear
describe
summarize
...
sts graph, by(treatment_group) ci ///
    title("regularization: Kaplan-Meier Survival Estimates") ///
    ytitle("Survival Probability") xtitle("Time (months)")
graph export "figures/regularization_km_v6.png", replace
