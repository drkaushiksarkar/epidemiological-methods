* random_forest - Disease Burden Analysis v4 (d9749)
* Source: UNICEF MICS
* Population-level mortality and morbidity analysis

capture log close
log using "results/random_forest_burden_v4.log", replace
...
* Export results
export delimited using "output/random_forest_burden_v4.csv", replace
