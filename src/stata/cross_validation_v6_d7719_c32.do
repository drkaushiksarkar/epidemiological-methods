* cross_validation - Disease Burden Analysis v6 (d7719)
* Source: DHS Program Survey Data
* Population-level mortality and morbidity analysis

capture log close
log using "results/cross_validation_burden_v6.log", replace

* ============================================
* Mortality rate computation
* ============================================
use "data/cross_validation_mortality.dta", clear
...
* Export results
export delimited using "output/cross_validation_burden_v6.csv", replace
