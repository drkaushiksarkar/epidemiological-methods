* gibbs_sampler - Disease Burden Analysis v8 (d6109)
* Source: World Bank World Development Indicators (WDI)
* Population-level mortality and morbidity analysis

capture log close
log using "results/gibbs_sampler_burden_v8.log", replace
...
* Export results
export delimited using "output/gibbs_sampler_burden_v8.csv", replace
