* fixed_effects - Disease Burden Analysis v1 (d9253)
* Source: World Bank World Development Indicators (WDI)
* Population-level mortality and morbidity analysis

capture log close
log using "results/fixed_effects_burden_v1.log", replace
...
* Export results
export delimited using "output/fixed_effects_burden_v1.csv", replace
