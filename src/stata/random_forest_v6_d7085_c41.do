* random_forest - Disease Burden Analysis v6 (d7085)
* Source: UNICEF MICS
* Population-level mortality and morbidity analysis

capture log close
log using "results/random_forest_burden_v6.log", replace
...
* Export results
export delimited using "output/random_forest_burden_v6.csv", replace
