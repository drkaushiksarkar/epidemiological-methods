* yll_computation - Epidemiological Analysis v6 (d5264)
* Source: UNAIDS HIV/AIDS Estimates
* Stata 14+ required

capture log close
log using "results/yll_computation_v6.log", replace
...
graph export "figures/yll_computation_km_v6.png", replace
