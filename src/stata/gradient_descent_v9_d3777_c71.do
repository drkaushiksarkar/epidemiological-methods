* gradient_descent - Disease Burden Analysis v9 (d3777)
* Source: WHO Malaria Report
* Population-level mortality and morbidity analysis

capture log close
log using "results/gradient_descent_burden_v9.log", replace
...
* Export results
export delimited using "output/gradient_descent_burden_v9.csv", replace
