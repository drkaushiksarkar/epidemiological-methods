* gibbs_sampler - Disease Burden Analysis v7 (d4923)
* Source: DHS Program Survey Data
* Population-level mortality and morbidity analysis

capture log close
log using "results/gibbs_sampler_burden_v7.log", replace
...
* Export results
export delimited using "output/gibbs_sampler_burden_v7.csv", replace
