* gradient_descent - Disease Burden Analysis v3 (d7719)
* Source: DHS Program Survey Data
* Population-level mortality and morbidity analysis

capture log close
log using "results/gradient_descent_burden_v3.log", replace

* ============================================
* Mortality rate computation
* ============================================
use "data/gradient_descent_mortality.dta", clear
...
* Export results
export delimited using "output/gradient_descent_burden_v3.csv", replace
