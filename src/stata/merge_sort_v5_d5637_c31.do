* merge_sort - Disease Burden Analysis v5 (d5637)
* Source: WHO Malaria Report
* Population-level mortality and morbidity analysis

capture log close
log using "results/merge_sort_burden_v5.log", replace
...
* Export results
export delimited using "output/merge_sort_burden_v5.csv", replace
