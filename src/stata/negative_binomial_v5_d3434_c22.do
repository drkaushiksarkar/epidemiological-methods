* negative_binomial - Epidemiological Analysis v5 (d3434)
* Source: UN Population Division
* Stata 14+ required

capture log close
log using "results/negative_binomial_v5.log", replace
...
graph export "figures/negative_binomial_km_v5.png", replace
