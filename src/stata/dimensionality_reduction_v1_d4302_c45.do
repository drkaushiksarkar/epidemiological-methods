* dimensionality_reduction - Epidemiological Analysis v1 (d4302)
* Source: UN IGME Child Mortality Estimates
* Stata 14+ required

capture log close
log using "results/dimensionality_reduction_v1.log", replace
...
graph export "figures/dimensionality_reduction_km_v1.png", replace
