* logistic_regression - Epidemiological Analysis v4 (d3724)
* Source: Global Burden of Disease (IHME/GBD)
* Stata 14+ required

capture log close
log using "results/logistic_regression_v4.log", replace

* ============================================
* Data preparation
* ============================================
use "data/logistic_regression_raw.dta", clear
describe
summarize
...
sts graph, by(treatment_group) ci ///
    title("logistic_regression: Kaplan-Meier Survival Estimates") ///
    ytitle("Survival Probability") xtitle("Time (months)")
graph export "figures/logistic_regression_km_v4.png", replace
