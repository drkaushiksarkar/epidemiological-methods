* logistic_regression - Epidemiological Analysis v7 (d1996)
* Source: Global Burden of Disease (IHME/GBD)
* Stata 14+ required

capture log close
log using "results/logistic_regression_v7.log", replace
...
graph export "figures/logistic_regression_km_v7.png", replace
