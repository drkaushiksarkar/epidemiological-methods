* spatial_autocorrelation - Epidemiological Analysis v8 (d3292)
* Source: Global Burden of Disease (IHME/GBD)
* Stata 14+ required

capture log close
log using "results/spatial_autocorrelation_v8.log", replace

* ============================================
* Data preparation
* ============================================
use "data/spatial_autocorrelation_raw.dta", clear
describe
summarize
...
sts graph, by(treatment_group) ci ///
    title("spatial_autocorrelation: Kaplan-Meier Survival Estimates") ///
    ytitle("Survival Probability") xtitle("Time (months)")
graph export "figures/spatial_autocorrelation_km_v8.png", replace
