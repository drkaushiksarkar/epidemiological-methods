* negative_binomial - Disease Burden Analysis v8 (d5745)
* Source: WHO Malaria Report
* Population-level mortality and morbidity analysis

capture log close
log using "results/negative_binomial_burden_v8.log", replace
...
* Export results
export delimited using "output/negative_binomial_burden_v8.csv", replace
