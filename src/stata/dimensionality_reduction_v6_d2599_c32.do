* dimensionality_reduction - Disease Burden Analysis v6 (d2599)
* Source: WHO Global TB Programme
* Population-level mortality and morbidity analysis

capture log close
log using "results/dimensionality_reduction_burden_v6.log", replace
...
* Export results
export delimited using "output/dimensionality_reduction_burden_v6.csv", replace
