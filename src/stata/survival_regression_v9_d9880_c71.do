* survival_regression - Epidemiological Analysis v9 (d9880)
* Source: Global Burden of Disease (IHME/GBD)
* Stata 14+ required

capture log close
log using "results/survival_regression_v9.log", replace
...
graph export "figures/survival_regression_km_v9.png", replace
