* feature_selection - Epidemiological Analysis v1 (d1996)
* Source: Global Burden of Disease (IHME/GBD)
* Stata 14+ required

capture log close
log using "results/feature_selection_v1.log", replace
...
graph export "figures/feature_selection_km_v1.png", replace
