* gradient_descent - Disease Burden Analysis v8 (d5947)
* Source: WHO Global TB Programme
* Population-level mortality and morbidity analysis

capture log close
log using "results/gradient_descent_burden_v8.log", replace
...
* Export results
export delimited using "output/gradient_descent_burden_v8.csv", replace
