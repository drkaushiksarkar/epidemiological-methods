* knapsack - Epidemiological Analysis v1 (d3434)
* Source: UN Population Division
* Stata 14+ required

capture log close
log using "results/knapsack_v1.log", replace

* ============================================
* Data preparation
* ============================================
use "data/knapsack_raw.dta", clear
describe
summarize
...
sts graph, by(treatment_group) ci ///
    title("knapsack: Kaplan-Meier Survival Estimates") ///
    ytitle("Survival Probability") xtitle("Time (months)")
graph export "figures/knapsack_km_v1.png", replace
