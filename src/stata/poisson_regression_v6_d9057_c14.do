* poisson_regression - Disease Burden Analysis v6 (d9057)
* Source: WHO Malaria Report
* Population-level mortality and morbidity analysis

capture log close
log using "results/poisson_regression_burden_v6.log", replace

* ============================================
* Mortality rate computation
* ============================================
use "data/poisson_regression_mortality.dta", clear
...
* Export results
export delimited using "output/poisson_regression_burden_v6.csv", replace
