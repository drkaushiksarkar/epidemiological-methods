* did_estimator - Epidemiological Analysis v2 (d3724)
* Source: Global Burden of Disease (IHME/GBD)
* Stata 14+ required

capture log close
log using "results/did_estimator_v2.log", replace

* ============================================
* Data preparation
* ============================================
use "data/did_estimator_raw.dta", clear
describe
summarize
...
sts graph, by(treatment_group) ci ///
    title("did_estimator: Kaplan-Meier Survival Estimates") ///
    ytitle("Survival Probability") xtitle("Time (months)")
graph export "figures/did_estimator_km_v2.png", replace
