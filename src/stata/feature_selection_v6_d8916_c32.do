* feature_selection - Epidemiological Analysis v6 (d8916)
* Source: WHO Global Health Observatory (GHO)
* Stata 14+ required

capture log close
log using "results/feature_selection_v6.log", replace
...
graph export "figures/feature_selection_km_v6.png", replace
