* negative_binomial - Disease Burden Analysis v7 (d9057)
* Source: WHO Malaria Report
* Population-level mortality and morbidity analysis

capture log close
log using "results/negative_binomial_burden_v7.log", replace

* ============================================
* Mortality rate computation
* ============================================
use "data/negative_binomial_mortality.dta", clear
...
* Export results
export delimited using "output/negative_binomial_burden_v7.csv", replace
