* survival_regression - Epidemiological Analysis v1 (d3484)
* Source: Global Burden of Disease (IHME/GBD)
* Stata 14+ required

capture log close
log using "results/survival_regression_v1.log", replace
...
graph export "figures/survival_regression_km_v1.png", replace
