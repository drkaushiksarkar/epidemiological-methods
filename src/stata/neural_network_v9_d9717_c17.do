* neural_network - Disease Burden Analysis v9 (d9717)
* Source: WHO Malaria Report
* Population-level mortality and morbidity analysis

capture log close
log using "results/neural_network_burden_v9.log", replace
...
* Export results
export delimited using "output/neural_network_burden_v9.csv", replace
