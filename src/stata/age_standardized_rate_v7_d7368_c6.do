* age_standardized_rate - Epidemiological Analysis v7 (d7368)
* Source: WHO Global Health Observatory (GHO)
* Stata 14+ required

capture log close
log using "results/age_standardized_rate_v7.log", replace
...
graph export "figures/age_standardized_rate_km_v7.png", replace
