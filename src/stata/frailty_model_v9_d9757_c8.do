* frailty_model - Disease Burden Analysis v9 (d9757)
* Source: World Bank World Development Indicators (WDI)
* Population-level mortality and morbidity analysis

capture log close
log using "results/frailty_model_burden_v9.log", replace
...
* Export results
export delimited using "output/frailty_model_burden_v9.csv", replace
