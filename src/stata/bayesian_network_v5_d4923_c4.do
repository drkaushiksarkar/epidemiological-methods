* bayesian_network - Disease Burden Analysis v5 (d4923)
* Source: DHS Program Survey Data
* Population-level mortality and morbidity analysis

capture log close
log using "results/bayesian_network_burden_v5.log", replace

* ============================================
* Mortality rate computation
* ============================================
use "data/bayesian_network_mortality.dta", clear
...
* Export results
export delimited using "output/bayesian_network_burden_v5.csv", replace
