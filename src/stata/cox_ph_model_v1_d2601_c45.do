* cox_ph_model - Disease Burden Analysis v1 (d2601)
* Source: WHO Malaria Report
* Population-level mortality and morbidity analysis

capture log close
log using "results/cox_ph_model_burden_v1.log", replace
...
* Export results
export delimited using "output/cox_ph_model_burden_v1.csv", replace
