* regularization - Disease Burden Analysis v7 (d8811)
* Source: DHS Program Survey Data
* Population-level mortality and morbidity analysis

capture log close
log using "results/regularization_burden_v7.log", replace

* ============================================
* Mortality rate computation
* ============================================
use "data/regularization_mortality.dta", clear
...
* Export results
export delimited using "output/regularization_burden_v7.csv", replace
