* did_estimator - Disease Burden Analysis v4 (d5367)
* Source: DHS Program Survey Data
* Population-level mortality and morbidity analysis

capture log close
log using "results/did_estimator_burden_v4.log", replace
...
* Export results
export delimited using "output/did_estimator_burden_v4.csv", replace
