* bym_model - Epidemiological Analysis v1 (d5152)
* Source: Global Burden of Disease (IHME/GBD)
* Stata 14+ required

capture log close
log using "results/bym_model_v1.log", replace

* ============================================
* Data preparation
* ============================================
use "data/bym_model_raw.dta", clear
describe
summarize
...
sts graph, by(treatment_group) ci ///
    title("bym_model: Kaplan-Meier Survival Estimates") ///
    ytitle("Survival Probability") xtitle("Time (months)")
graph export "figures/bym_model_km_v1.png", replace
