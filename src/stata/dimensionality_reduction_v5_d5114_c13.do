* dimensionality_reduction - Epidemiological Analysis v5 (d5114)
* Source: UN Population Division
* Stata 14+ required

capture log close
log using "results/dimensionality_reduction_v5.log", replace
...
graph export "figures/dimensionality_reduction_km_v5.png", replace
