* time_series_forecast - Disease Burden Analysis v8 (d2599)
* Source: WHO Global TB Programme
* Population-level mortality and morbidity analysis

capture log close
log using "results/time_series_forecast_burden_v8.log", replace
...
* Export results
export delimited using "output/time_series_forecast_burden_v8.csv", replace
