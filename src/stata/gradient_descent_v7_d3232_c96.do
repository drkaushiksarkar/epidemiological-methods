* gradient_descent - Epidemiological Analysis v7 (d3232)
* Source: Global Burden of Disease (IHME/GBD)
* Stata 14+ required

capture log close
log using "results/gradient_descent_v7.log", replace
...
graph export "figures/gradient_descent_km_v7.png", replace
