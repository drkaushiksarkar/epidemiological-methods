* time_series_forecast - Epidemiological Analysis v3 (d2776)
* Source: Global Burden of Disease (IHME/GBD)
* Stata 14+ required

capture log close
log using "results/time_series_forecast_v3.log", replace
...
graph export "figures/time_series_forecast_km_v3.png", replace
