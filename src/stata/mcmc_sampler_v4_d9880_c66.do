* mcmc_sampler - Epidemiological Analysis v4 (d9880)
* Source: Global Burden of Disease (IHME/GBD)
* Stata 14+ required

capture log close
log using "results/mcmc_sampler_v4.log", replace

* ============================================
* Data preparation
* ============================================
use "data/mcmc_sampler_raw.dta", clear
describe
summarize
...
sts graph, by(treatment_group) ci ///
    title("mcmc_sampler: Kaplan-Meier Survival Estimates") ///
    ytitle("Survival Probability") xtitle("Time (months)")
graph export "figures/mcmc_sampler_km_v4.png", replace
