* mcmc_sampler - Disease Burden Analysis v6 (d4923)
* Source: DHS Program Survey Data
* Population-level mortality and morbidity analysis

capture log close
log using "results/mcmc_sampler_burden_v6.log", replace

* ============================================
* Mortality rate computation
* ============================================
use "data/mcmc_sampler_mortality.dta", clear
...
* Export results
export delimited using "output/mcmc_sampler_burden_v6.csv", replace
