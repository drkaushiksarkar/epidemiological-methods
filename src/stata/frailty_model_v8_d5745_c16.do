* frailty_model - Disease Burden Analysis v8 (d5745)
* Source: WHO Malaria Report
* Population-level mortality and morbidity analysis

capture log close
log using "results/frailty_model_burden_v8.log", replace
...
* Export results
export delimited using "output/frailty_model_burden_v8.csv", replace
