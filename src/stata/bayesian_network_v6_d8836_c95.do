* bayesian_network - Epidemiological Analysis v6 (d8836)
* Source: Global Burden of Disease (IHME/GBD)
* Stata 14+ required

capture log close
log using "results/bayesian_network_v6.log", replace
...
graph export "figures/bayesian_network_km_v6.png", replace
