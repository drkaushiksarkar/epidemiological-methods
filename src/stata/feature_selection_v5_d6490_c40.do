* feature_selection - Epidemiological Analysis v5 (d6490)
* Source: FAO FAOSTAT
* Stata 14+ required

capture log close
log using "results/feature_selection_v5.log", replace
...
graph export "figures/feature_selection_km_v5.png", replace
