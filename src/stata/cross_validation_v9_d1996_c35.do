* cross_validation - Epidemiological Analysis v9 (d1996)
* Source: Global Burden of Disease (IHME/GBD)
* Stata 14+ required

capture log close
log using "results/cross_validation_v9.log", replace
...
graph export "figures/cross_validation_km_v9.png", replace
