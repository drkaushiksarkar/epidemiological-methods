* daly_estimate - Disease Burden Analysis v2 (d6569)
* Source: UNICEF MICS
* Population-level mortality and morbidity analysis

capture log close
log using "results/daly_estimate_burden_v2.log", replace

* ============================================
* Mortality rate computation
* ============================================
use "data/daly_estimate_mortality.dta", clear
...
* Export results
export delimited using "output/daly_estimate_burden_v2.csv", replace
