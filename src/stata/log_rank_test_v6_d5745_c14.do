* log_rank_test - Disease Burden Analysis v6 (d5745)
* Source: WHO Malaria Report
* Population-level mortality and morbidity analysis

capture log close
log using "results/log_rank_test_burden_v6.log", replace
...
* Export results
export delimited using "output/log_rank_test_burden_v6.csv", replace
