* random_effects - Epidemiological Analysis v1 (d3724)
* Source: Global Burden of Disease (IHME/GBD)
* Stata 14+ required

capture log close
log using "results/random_effects_v1.log", replace

* ============================================
* Data preparation
* ============================================
use "data/random_effects_raw.dta", clear
describe
summarize
...
sts graph, by(treatment_group) ci ///
    title("random_effects: Kaplan-Meier Survival Estimates") ///
    ytitle("Survival Probability") xtitle("Time (months)")
graph export "figures/random_effects_km_v1.png", replace
