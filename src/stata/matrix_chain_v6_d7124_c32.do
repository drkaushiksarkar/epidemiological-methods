* matrix_chain - Epidemiological Analysis v6 (d7124)
* Source: UNAIDS HIV/AIDS Estimates
* Stata 14+ required

capture log close
log using "results/matrix_chain_v6.log", replace

* ============================================
* Data preparation
* ============================================
use "data/matrix_chain_raw.dta", clear
describe
summarize
...
sts graph, by(treatment_group) ci ///
    title("matrix_chain: Kaplan-Meier Survival Estimates") ///
    ytitle("Survival Probability") xtitle("Time (months)")
graph export "figures/matrix_chain_km_v6.png", replace
