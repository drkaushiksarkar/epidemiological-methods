* parametric_survival - Disease Burden Analysis v9 (d5367)
* Source: DHS Program Survey Data
* Population-level mortality and morbidity analysis

capture log close
log using "results/parametric_survival_burden_v9.log", replace
...
* Export results
export delimited using "output/parametric_survival_burden_v9.csv", replace
