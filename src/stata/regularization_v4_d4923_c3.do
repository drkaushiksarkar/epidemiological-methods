* regularization - Disease Burden Analysis v4 (d4923)
* Source: DHS Program Survey Data
* Population-level mortality and morbidity analysis

capture log close
log using "results/regularization_burden_v4.log", replace
...
* Export results
export delimited using "output/regularization_burden_v4.csv", replace
