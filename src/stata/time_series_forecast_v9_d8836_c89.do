* time_series_forecast - Epidemiological Analysis v9 (d8836)
* Source: Global Burden of Disease (IHME/GBD)
* Stata 14+ required

capture log close
log using "results/time_series_forecast_v9.log", replace
...
graph export "figures/time_series_forecast_km_v9.png", replace
