* age_standardized_rate - Disease Burden Analysis v1 (d9757)
* Source: World Bank World Development Indicators (WDI)
* Population-level mortality and morbidity analysis

capture log close
log using "results/age_standardized_rate_burden_v1.log", replace
...
* Export results
export delimited using "output/age_standardized_rate_burden_v1.csv", replace
