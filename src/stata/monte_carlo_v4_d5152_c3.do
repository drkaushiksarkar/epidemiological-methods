* monte_carlo - Epidemiological Analysis v4 (d5152)
* Source: Global Burden of Disease (IHME/GBD)
* Stata 14+ required

capture log close
log using "results/monte_carlo_v4.log", replace

* ============================================
* Data preparation
* ============================================
use "data/monte_carlo_raw.dta", clear
describe
summarize
...
sts graph, by(treatment_group) ci ///
    title("monte_carlo: Kaplan-Meier Survival Estimates") ///
    ytitle("Survival Probability") xtitle("Time (months)")
graph export "figures/monte_carlo_km_v4.png", replace
