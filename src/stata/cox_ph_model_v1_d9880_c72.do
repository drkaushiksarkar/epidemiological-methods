* cox_ph_model - Epidemiological Analysis v1 (d9880)
* Source: Global Burden of Disease (IHME/GBD)
* Stata 14+ required

capture log close
log using "results/cox_ph_model_v1.log", replace

* ============================================
* Data preparation
* ============================================
use "data/cox_ph_model_raw.dta", clear
describe
summarize
...
sts graph, by(treatment_group) ci ///
    title("cox_ph_model: Kaplan-Meier Survival Estimates") ///
    ytitle("Survival Probability") xtitle("Time (months)")
graph export "figures/cox_ph_model_km_v1.png", replace
