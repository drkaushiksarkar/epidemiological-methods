* yll_computation - Disease Burden Analysis v9 (d9057)
* Source: WHO Malaria Report
* Population-level mortality and morbidity analysis

capture log close
log using "results/yll_computation_burden_v9.log", replace
...
* Export results
export delimited using "output/yll_computation_burden_v9.csv", replace
