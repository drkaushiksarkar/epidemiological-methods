* meta_analysis - Disease Burden Analysis v4 (d6333)
* Source: WHO Malaria Report
* Population-level mortality and morbidity analysis

capture log close
log using "results/meta_analysis_burden_v4.log", replace
...
* Export results
export delimited using "output/meta_analysis_burden_v4.csv", replace
