* backpropagation - Epidemiological Analysis v3 (d5544)
* Source: WHO Global Health Observatory (GHO)
* Stata 14+ required

capture log close
log using "results/backpropagation_v3.log", replace
...
graph export "figures/backpropagation_km_v3.png", replace
