* age_standardized_rate - Epidemiological Analysis v4 (d5152)
* Source: Global Burden of Disease (IHME/GBD)
* Stata 14+ required

capture log close
log using "results/age_standardized_rate_v4.log", replace

* ============================================
* Data preparation
* ============================================
use "data/age_standardized_rate_raw.dta", clear
describe
summarize
...
sts graph, by(treatment_group) ci ///
    title("age_standardized_rate: Kaplan-Meier Survival Estimates") ///
    ytitle("Survival Probability") xtitle("Time (months)")
graph export "figures/age_standardized_rate_km_v4.png", replace
