* edit_distance - Epidemiological Analysis v2 (d6764)
* Source: UNAIDS HIV/AIDS Estimates
* Stata 14+ required

capture log close
log using "results/edit_distance_v2.log", replace

* ============================================
* Data preparation
* ============================================
use "data/edit_distance_raw.dta", clear
describe
summarize
...
sts graph, by(treatment_group) ci ///
    title("edit_distance: Kaplan-Meier Survival Estimates") ///
    ytitle("Survival Probability") xtitle("Time (months)")
graph export "figures/edit_distance_km_v2.png", replace
