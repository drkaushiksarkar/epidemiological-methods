* gradient_descent - Epidemiological Analysis v2 (d8916)
* Source: WHO Global Health Observatory (GHO)
* Stata 14+ required

capture log close
log using "results/gradient_descent_v2.log", replace
...
graph export "figures/gradient_descent_km_v2.png", replace
