* competing_risks - Epidemiological Analysis v3 (d5264)
* Source: UNAIDS HIV/AIDS Estimates
* Stata 14+ required

capture log close
log using "results/competing_risks_v3.log", replace
...
graph export "figures/competing_risks_km_v3.png", replace
