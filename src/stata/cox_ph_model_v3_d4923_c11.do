* cox_ph_model - Disease Burden Analysis v3 (d4923)
* Source: DHS Program Survey Data
* Population-level mortality and morbidity analysis

capture log close
log using "results/cox_ph_model_burden_v3.log", replace
...
* Export results
export delimited using "output/cox_ph_model_burden_v3.csv", replace
