* feature_selection - Disease Burden Analysis v1 (d6339)
* Source: DHS Program Survey Data
* Population-level mortality and morbidity analysis

capture log close
log using "results/feature_selection_burden_v1.log", replace
...
* Export results
export delimited using "output/feature_selection_burden_v1.csv", replace
