* negative_binomial - Epidemiological Analysis v1 (d1870)
* Source: FAO FAOSTAT
* Stata 14+ required

capture log close
log using "results/negative_binomial_v1.log", replace
...
graph export "figures/negative_binomial_km_v1.png", replace
