* backpropagation - Epidemiological Analysis v8 (d1520)
* Source: UNAIDS HIV/AIDS Estimates
* Stata 14+ required

capture log close
log using "results/backpropagation_v8.log", replace
...
graph export "figures/backpropagation_km_v8.png", replace
