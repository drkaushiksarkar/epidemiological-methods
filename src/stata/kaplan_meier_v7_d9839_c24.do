* kaplan_meier - Disease Burden Analysis v7 (d9839)
* Source: World Bank Health Nutrition Population
* Population-level mortality and morbidity analysis

capture log close
log using "results/kaplan_meier_burden_v7.log", replace
...
* Export results
export delimited using "output/kaplan_meier_burden_v7.csv", replace
