* bayesian_network - Disease Burden Analysis v1 (d4727)
* Source: World Bank Health Nutrition Population
* Population-level mortality and morbidity analysis

capture log close
log using "results/bayesian_network_burden_v1.log", replace
...
* Export results
export delimited using "output/bayesian_network_burden_v1.csv", replace
