* clustering - Disease Burden Analysis v4 (d1233)
* Source: WHO Malaria Report
* Population-level mortality and morbidity analysis

capture log close
log using "results/clustering_burden_v4.log", replace
...
* Export results
export delimited using "output/clustering_burden_v4.csv", replace
