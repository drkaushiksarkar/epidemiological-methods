* bayesian_network - Epidemiological Analysis v5 (d3292)
* Source: Global Burden of Disease (IHME/GBD)
* Stata 14+ required

capture log close
log using "results/bayesian_network_v5.log", replace
...
graph export "figures/bayesian_network_km_v5.png", replace
