* meta_analysis - Disease Burden Analysis v3 (d5745)
* Source: WHO Malaria Report
* Population-level mortality and morbidity analysis

capture log close
log using "results/meta_analysis_burden_v3.log", replace

* ============================================
* Mortality rate computation
* ============================================
use "data/meta_analysis_mortality.dta", clear
...
* Export results
export delimited using "output/meta_analysis_burden_v3.csv", replace
