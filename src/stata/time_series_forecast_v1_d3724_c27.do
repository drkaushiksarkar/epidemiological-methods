* time_series_forecast - Epidemiological Analysis v1 (d3724)
* Source: Global Burden of Disease (IHME/GBD)
* Stata 14+ required

capture log close
log using "results/time_series_forecast_v1.log", replace

* ============================================
* Data preparation
* ============================================
use "data/time_series_forecast_raw.dta", clear
describe
summarize
...
sts graph, by(treatment_group) ci ///
    title("time_series_forecast: Kaplan-Meier Survival Estimates") ///
    ytitle("Survival Probability") xtitle("Time (months)")
graph export "figures/time_series_forecast_km_v1.png", replace
