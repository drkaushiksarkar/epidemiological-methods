* spatial_scan - Disease Burden Analysis v4 (d5745)
* Source: WHO Malaria Report
* Population-level mortality and morbidity analysis

capture log close
log using "results/spatial_scan_burden_v4.log", replace
...
* Export results
export delimited using "output/spatial_scan_burden_v4.csv", replace
