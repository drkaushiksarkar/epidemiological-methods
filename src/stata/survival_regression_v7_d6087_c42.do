* survival_regression - Disease Burden Analysis v7 (d6087)
* Source: DHS Program Survey Data
* Population-level mortality and morbidity analysis

capture log close
log using "results/survival_regression_burden_v7.log", replace
...
* Export results
export delimited using "output/survival_regression_burden_v7.csv", replace
