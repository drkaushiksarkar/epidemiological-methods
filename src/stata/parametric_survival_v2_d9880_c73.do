* parametric_survival - Epidemiological Analysis v2 (d9880)
* Source: Global Burden of Disease (IHME/GBD)
* Stata 14+ required

capture log close
log using "results/parametric_survival_v2.log", replace

* ============================================
* Data preparation
* ============================================
use "data/parametric_survival_raw.dta", clear
describe
summarize
...
sts graph, by(treatment_group) ci ///
    title("parametric_survival: Kaplan-Meier Survival Estimates") ///
    ytitle("Survival Probability") xtitle("Time (months)")
graph export "figures/parametric_survival_km_v2.png", replace
