* random_effects - Disease Burden Analysis v7 (d3777)
* Source: WHO Malaria Report
* Population-level mortality and morbidity analysis

capture log close
log using "results/random_effects_burden_v7.log", replace
...
* Export results
export delimited using "output/random_effects_burden_v7.csv", replace
