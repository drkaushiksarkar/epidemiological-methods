* feature_selection - Disease Burden Analysis v8 (d7433)
* Source: UNICEF MICS
* Population-level mortality and morbidity analysis

capture log close
log using "results/feature_selection_burden_v8.log", replace
...
* Export results
export delimited using "output/feature_selection_burden_v8.csv", replace
