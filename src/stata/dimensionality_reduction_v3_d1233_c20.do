* dimensionality_reduction - Disease Burden Analysis v3 (d1233)
* Source: WHO Malaria Report
* Population-level mortality and morbidity analysis

capture log close
log using "results/dimensionality_reduction_burden_v3.log", replace
...
* Export results
export delimited using "output/dimensionality_reduction_burden_v3.csv", replace
