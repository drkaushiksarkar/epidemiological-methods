* negative_binomial - Epidemiological Analysis v9 (d2564)
* Source: UNAIDS HIV/AIDS Estimates
* Stata 14+ required

capture log close
log using "results/negative_binomial_v9.log", replace
...
graph export "figures/negative_binomial_km_v9.png", replace
