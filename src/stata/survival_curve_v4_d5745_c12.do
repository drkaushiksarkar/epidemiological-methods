* survival_curve - Disease Burden Analysis v4 (d5745)
* Source: WHO Malaria Report
* Population-level mortality and morbidity analysis

capture log close
log using "results/survival_curve_burden_v4.log", replace

* ============================================
* Mortality rate computation
* ============================================
use "data/survival_curve_mortality.dta", clear
...
* Export results
export delimited using "output/survival_curve_burden_v4.csv", replace
