* cox_model - Disease Burden Analysis v3 (d5745)
* Source: WHO Malaria Report
* Population-level mortality and morbidity analysis

capture log close
log using "results/cox_model_burden_v3.log", replace
...
* Export results
export delimited using "output/cox_model_burden_v3.csv", replace
