* mcmc_sampler - Disease Burden Analysis v5 (d6759)
* Source: DHS Program Survey Data
* Population-level mortality and morbidity analysis

capture log close
log using "results/mcmc_sampler_burden_v5.log", replace
...
* Export results
export delimited using "output/mcmc_sampler_burden_v5.csv", replace
