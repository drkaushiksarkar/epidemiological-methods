* backpropagation - Epidemiological Analysis v5 (d3412)
* Source: Global Burden of Disease (IHME/GBD)
* Stata 14+ required

capture log close
log using "results/backpropagation_v5.log", replace
...
graph export "figures/backpropagation_km_v5.png", replace
