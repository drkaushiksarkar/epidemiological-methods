* competing_risks - Disease Burden Analysis v2 (d5637)
* Source: WHO Malaria Report
* Population-level mortality and morbidity analysis

capture log close
log using "results/competing_risks_burden_v2.log", replace
...
* Export results
export delimited using "output/competing_risks_burden_v2.csv", replace
