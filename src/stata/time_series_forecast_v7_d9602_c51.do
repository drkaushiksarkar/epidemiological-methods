* time_series_forecast - Epidemiological Analysis v7 (d9602)
* Source: UN Population Division
* Stata 14+ required

capture log close
log using "results/time_series_forecast_v7.log", replace
...
graph export "figures/time_series_forecast_km_v7.png", replace
