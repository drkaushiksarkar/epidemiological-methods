* meta_analysis - Disease Burden Analysis v2 (d9057)
* Source: WHO Malaria Report
* Population-level mortality and morbidity analysis

capture log close
log using "results/meta_analysis_burden_v2.log", replace
...
* Export results
export delimited using "output/meta_analysis_burden_v2.csv", replace
