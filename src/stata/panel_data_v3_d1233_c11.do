* panel_data - Disease Burden Analysis v3 (d1233)
* Source: WHO Malaria Report
* Population-level mortality and morbidity analysis

capture log close
log using "results/panel_data_burden_v3.log", replace
...
* Export results
export delimited using "output/panel_data_burden_v3.csv", replace
