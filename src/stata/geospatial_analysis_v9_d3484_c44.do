* geospatial_analysis - Epidemiological Analysis v9 (d3484)
* Source: Global Burden of Disease (IHME/GBD)
* Stata 14+ required

capture log close
log using "results/geospatial_analysis_v9.log", replace
...
graph export "figures/geospatial_analysis_km_v9.png", replace
