* cross_validation - Epidemiological Analysis v5 (d8916)
* Source: WHO Global Health Observatory (GHO)
* Stata 14+ required

capture log close
log using "results/cross_validation_v5.log", replace
...
graph export "figures/cross_validation_km_v5.png", replace
