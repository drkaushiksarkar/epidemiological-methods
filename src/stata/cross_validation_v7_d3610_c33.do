* cross_validation - Epidemiological Analysis v7 (d3610)
* Source: FAO FAOSTAT
* Stata 14+ required

capture log close
log using "results/cross_validation_v7.log", replace
...
graph export "figures/cross_validation_km_v7.png", replace
