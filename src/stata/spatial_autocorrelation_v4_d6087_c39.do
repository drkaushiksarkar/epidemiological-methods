* spatial_autocorrelation - Disease Burden Analysis v4 (d6087)
* Source: DHS Program Survey Data
* Population-level mortality and morbidity analysis

capture log close
log using "results/spatial_autocorrelation_burden_v4.log", replace

* ============================================
* Mortality rate computation
* ============================================
use "data/spatial_autocorrelation_mortality.dta", clear
...
* Export results
export delimited using "output/spatial_autocorrelation_burden_v4.csv", replace
