* fixed_effects - Disease Burden Analysis v5 (d5947)
* Source: WHO Global TB Programme
* Population-level mortality and morbidity analysis

capture log close
log using "results/fixed_effects_burden_v5.log", replace
...
* Export results
export delimited using "output/fixed_effects_burden_v5.csv", replace
