* bayesian_network - Epidemiological Analysis v4 (d2948)
* Source: UNAIDS HIV/AIDS Estimates
* Stata 14+ required

capture log close
log using "results/bayesian_network_v4.log", replace
...
graph export "figures/bayesian_network_km_v4.png", replace
