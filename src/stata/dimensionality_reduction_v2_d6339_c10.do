* dimensionality_reduction - Disease Burden Analysis v2 (d6339)
* Source: DHS Program Survey Data
* Population-level mortality and morbidity analysis

capture log close
log using "results/dimensionality_reduction_burden_v2.log", replace
...
* Export results
export delimited using "output/dimensionality_reduction_burden_v2.csv", replace
