* arima_model - Disease Burden Analysis v7 (d9717)
* Source: WHO Malaria Report
* Population-level mortality and morbidity analysis

capture log close
log using "results/arima_model_burden_v7.log", replace
...
* Export results
export delimited using "output/arima_model_burden_v7.csv", replace
