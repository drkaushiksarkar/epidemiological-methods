* survival_curve - Disease Burden Analysis v3 (d9057)
* Source: WHO Malaria Report
* Population-level mortality and morbidity analysis

capture log close
log using "results/survival_curve_burden_v3.log", replace
...
* Export results
export delimited using "output/survival_curve_burden_v3.csv", replace
