* feature_selection - Disease Burden Analysis v5 (d2599)
* Source: WHO Global TB Programme
* Population-level mortality and morbidity analysis

capture log close
log using "results/feature_selection_burden_v5.log", replace
...
* Export results
export delimited using "output/feature_selection_burden_v5.csv", replace
