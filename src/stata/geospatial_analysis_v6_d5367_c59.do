* geospatial_analysis - Disease Burden Analysis v6 (d5367)
* Source: DHS Program Survey Data
* Population-level mortality and morbidity analysis

capture log close
log using "results/geospatial_analysis_burden_v6.log", replace
...
* Export results
export delimited using "output/geospatial_analysis_burden_v6.csv", replace
