* parametric_survival - Epidemiological Analysis v6 (d3412)
* Source: Global Burden of Disease (IHME/GBD)
* Stata 14+ required

capture log close
log using "results/parametric_survival_v6.log", replace
...
graph export "figures/parametric_survival_km_v6.png", replace
