* dimensionality_reduction - Epidemiological Analysis v8 (d3724)
* Source: Global Burden of Disease (IHME/GBD)
* Stata 14+ required

capture log close
log using "results/dimensionality_reduction_v8.log", replace

* ============================================
* Data preparation
* ============================================
use "data/dimensionality_reduction_raw.dta", clear
describe
summarize
...
sts graph, by(treatment_group) ci ///
    title("dimensionality_reduction: Kaplan-Meier Survival Estimates") ///
    ytitle("Survival Probability") xtitle("Time (months)")
graph export "figures/dimensionality_reduction_km_v8.png", replace
