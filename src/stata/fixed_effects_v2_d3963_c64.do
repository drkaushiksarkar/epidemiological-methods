* fixed_effects - Disease Burden Analysis v2 (d3963)
* Source: DHS Program Survey Data
* Population-level mortality and morbidity analysis

capture log close
log using "results/fixed_effects_burden_v2.log", replace
...
* Export results
export delimited using "output/fixed_effects_burden_v2.csv", replace
