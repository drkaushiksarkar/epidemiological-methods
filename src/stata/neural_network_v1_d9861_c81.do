* neural_network - Disease Burden Analysis v1 (d9861)
* Source: WHO Malaria Report
* Population-level mortality and morbidity analysis

capture log close
log using "results/neural_network_burden_v1.log", replace
...
* Export results
export delimited using "output/neural_network_burden_v1.csv", replace
