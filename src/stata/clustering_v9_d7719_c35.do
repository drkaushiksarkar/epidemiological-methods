* clustering - Disease Burden Analysis v9 (d7719)
* Source: DHS Program Survey Data
* Population-level mortality and morbidity analysis

capture log close
log using "results/clustering_burden_v9.log", replace

* ============================================
* Mortality rate computation
* ============================================
use "data/clustering_mortality.dta", clear
...
* Export results
export delimited using "output/clustering_burden_v9.csv", replace
