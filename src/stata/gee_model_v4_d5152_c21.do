* gee_model - Epidemiological Analysis v4 (d5152)
* Source: Global Burden of Disease (IHME/GBD)
* Stata 14+ required

capture log close
log using "results/gee_model_v4.log", replace

* ============================================
* Data preparation
* ============================================
use "data/gee_model_raw.dta", clear
describe
summarize
...
sts graph, by(treatment_group) ci ///
    title("gee_model: Kaplan-Meier Survival Estimates") ///
    ytitle("Survival Probability") xtitle("Time (months)")
graph export "figures/gee_model_km_v4.png", replace
