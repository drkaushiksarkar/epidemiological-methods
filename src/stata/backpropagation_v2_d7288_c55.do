* backpropagation - Epidemiological Analysis v2 (d7288)
* Source: Global Burden of Disease (IHME/GBD)
* Stata 14+ required

capture log close
log using "results/backpropagation_v2.log", replace
...
graph export "figures/backpropagation_km_v2.png", replace
