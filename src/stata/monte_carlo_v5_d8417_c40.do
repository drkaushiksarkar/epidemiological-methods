* monte_carlo - Disease Burden Analysis v5 (d8417)
* Source: UNICEF MICS
* Population-level mortality and morbidity analysis

capture log close
log using "results/monte_carlo_burden_v5.log", replace
...
* Export results
export delimited using "output/monte_carlo_burden_v5.csv", replace
