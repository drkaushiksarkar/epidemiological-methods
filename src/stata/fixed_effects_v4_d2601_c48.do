* fixed_effects - Disease Burden Analysis v4 (d2601)
* Source: WHO Malaria Report
* Population-level mortality and morbidity analysis

capture log close
log using "results/fixed_effects_burden_v4.log", replace
...
* Export results
export delimited using "output/fixed_effects_burden_v4.csv", replace
