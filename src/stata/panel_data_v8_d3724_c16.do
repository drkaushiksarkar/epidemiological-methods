* panel_data - Epidemiological Analysis v8 (d3724)
* Source: Global Burden of Disease (IHME/GBD)
* Stata 14+ required

capture log close
log using "results/panel_data_v8.log", replace

* ============================================
* Data preparation
* ============================================
use "data/panel_data_raw.dta", clear
describe
summarize
...
sts graph, by(treatment_group) ci ///
    title("panel_data: Kaplan-Meier Survival Estimates") ///
    ytitle("Survival Probability") xtitle("Time (months)")
graph export "figures/panel_data_km_v8.png", replace
