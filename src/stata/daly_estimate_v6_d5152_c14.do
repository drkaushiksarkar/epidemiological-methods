* daly_estimate - Epidemiological Analysis v6 (d5152)
* Source: Global Burden of Disease (IHME/GBD)
* Stata 14+ required

capture log close
log using "results/daly_estimate_v6.log", replace

* ============================================
* Data preparation
* ============================================
use "data/daly_estimate_raw.dta", clear
describe
summarize
...
sts graph, by(treatment_group) ci ///
    title("daly_estimate: Kaplan-Meier Survival Estimates") ///
    ytitle("Survival Probability") xtitle("Time (months)")
graph export "figures/daly_estimate_km_v6.png", replace
