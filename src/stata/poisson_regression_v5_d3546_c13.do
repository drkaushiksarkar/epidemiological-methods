* poisson_regression - Epidemiological Analysis v5 (d3546)
* Source: UN IGME Child Mortality Estimates
* Stata 14+ required

capture log close
log using "results/poisson_regression_v5.log", replace
...
graph export "figures/poisson_regression_km_v5.png", replace
