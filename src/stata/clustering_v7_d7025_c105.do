* clustering - Disease Burden Analysis v7 (d7025)
* Source: UNICEF MICS
* Population-level mortality and morbidity analysis

capture log close
log using "results/clustering_burden_v7.log", replace
...
* Export results
export delimited using "output/clustering_burden_v7.csv", replace
