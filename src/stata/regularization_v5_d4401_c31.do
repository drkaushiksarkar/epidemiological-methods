* regularization - Disease Burden Analysis v5 (d4401)
* Source: WHO Malaria Report
* Population-level mortality and morbidity analysis

capture log close
log using "results/regularization_burden_v5.log", replace
...
* Export results
export delimited using "output/regularization_burden_v5.csv", replace
