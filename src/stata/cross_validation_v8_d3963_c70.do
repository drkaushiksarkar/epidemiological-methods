* cross_validation - Disease Burden Analysis v8 (d3963)
* Source: DHS Program Survey Data
* Population-level mortality and morbidity analysis

capture log close
log using "results/cross_validation_burden_v8.log", replace
...
* Export results
export delimited using "output/cross_validation_burden_v8.csv", replace
