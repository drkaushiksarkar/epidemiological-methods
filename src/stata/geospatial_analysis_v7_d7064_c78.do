* geospatial_analysis - Epidemiological Analysis v7 (d7064)
* Source: UNAIDS HIV/AIDS Estimates
* Stata 14+ required

capture log close
log using "results/geospatial_analysis_v7.log", replace
...
graph export "figures/geospatial_analysis_km_v7.png", replace
