* arima_model - Disease Burden Analysis v8 (d7047)
* Source: DHS Program Survey Data
* Population-level mortality and morbidity analysis

capture log close
log using "results/arima_model_burden_v8.log", replace

* ============================================
* Mortality rate computation
* ============================================
use "data/arima_model_mortality.dta", clear
...
* Export results
export delimited using "output/arima_model_burden_v8.csv", replace
