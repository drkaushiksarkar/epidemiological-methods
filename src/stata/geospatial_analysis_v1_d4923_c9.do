* geospatial_analysis - Disease Burden Analysis v1 (d4923)
* Source: DHS Program Survey Data
* Population-level mortality and morbidity analysis

capture log close
log using "results/geospatial_analysis_burden_v1.log", replace
...
* Export results
export delimited using "output/geospatial_analysis_burden_v1.csv", replace
