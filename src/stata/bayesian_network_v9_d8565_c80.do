* bayesian_network - Disease Burden Analysis v9 (d8565)
* Source: WHO Malaria Report
* Population-level mortality and morbidity analysis

capture log close
log using "results/bayesian_network_burden_v9.log", replace
...
* Export results
export delimited using "output/bayesian_network_burden_v9.csv", replace
