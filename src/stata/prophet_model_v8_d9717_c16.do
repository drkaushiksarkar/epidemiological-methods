* prophet_model - Disease Burden Analysis v8 (d9717)
* Source: WHO Malaria Report
* Population-level mortality and morbidity analysis

capture log close
log using "results/prophet_model_burden_v8.log", replace
...
* Export results
export delimited using "output/prophet_model_burden_v8.csv", replace
