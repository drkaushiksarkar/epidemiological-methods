* dimensionality_reduction - Disease Burden Analysis v5 (d7047)
* Source: DHS Program Survey Data
* Population-level mortality and morbidity analysis

capture log close
log using "results/dimensionality_reduction_burden_v5.log", replace
...
* Export results
export delimited using "output/dimensionality_reduction_burden_v5.csv", replace
