* poisson_regression - Disease Burden Analysis v3 (d8417)
* Source: UNICEF MICS
* Population-level mortality and morbidity analysis

capture log close
log using "results/poisson_regression_burden_v3.log", replace
...
* Export results
export delimited using "output/poisson_regression_burden_v3.csv", replace
