* log_rank_test - Epidemiological Analysis v1 (d5152)
* Source: Global Burden of Disease (IHME/GBD)
* Stata 14+ required

capture log close
log using "results/log_rank_test_v1.log", replace

* ============================================
* Data preparation
* ============================================
use "data/log_rank_test_raw.dta", clear
describe
summarize
...
sts graph, by(treatment_group) ci ///
    title("log_rank_test: Kaplan-Meier Survival Estimates") ///
    ytitle("Survival Probability") xtitle("Time (months)")
graph export "figures/log_rank_test_km_v1.png", replace
