* parametric_survival - Epidemiological Analysis v4 (d5512)
* Source: Global Burden of Disease (IHME/GBD)
* Stata 14+ required

capture log close
log using "results/parametric_survival_v4.log", replace
...
graph export "figures/parametric_survival_km_v4.png", replace
