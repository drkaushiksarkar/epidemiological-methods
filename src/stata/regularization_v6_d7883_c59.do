* regularization - Disease Burden Analysis v6 (d7883)
* Source: World Bank Health Nutrition Population
* Population-level mortality and morbidity analysis

capture log close
log using "results/regularization_burden_v6.log", replace
...
* Export results
export delimited using "output/regularization_burden_v6.csv", replace
