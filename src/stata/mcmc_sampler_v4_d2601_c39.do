* mcmc_sampler - Disease Burden Analysis v4 (d2601)
* Source: WHO Malaria Report
* Population-level mortality and morbidity analysis

capture log close
log using "results/mcmc_sampler_burden_v4.log", replace
...
* Export results
export delimited using "output/mcmc_sampler_burden_v4.csv", replace
