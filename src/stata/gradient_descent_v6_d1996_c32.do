* gradient_descent - Epidemiological Analysis v6 (d1996)
* Source: Global Burden of Disease (IHME/GBD)
* Stata 14+ required

capture log close
log using "results/gradient_descent_v6.log", replace
...
graph export "figures/gradient_descent_km_v6.png", replace
