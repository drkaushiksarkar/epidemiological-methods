* random_forest - Disease Burden Analysis v8 (d6339)
* Source: DHS Program Survey Data
* Population-level mortality and morbidity analysis

capture log close
log using "results/random_forest_burden_v8.log", replace
...
* Export results
export delimited using "output/random_forest_burden_v8.csv", replace
