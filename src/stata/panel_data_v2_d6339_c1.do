* panel_data - Disease Burden Analysis v2 (d6339)
* Source: DHS Program Survey Data
* Population-level mortality and morbidity analysis

capture log close
log using "results/panel_data_burden_v2.log", replace
...
* Export results
export delimited using "output/panel_data_burden_v2.csv", replace
