* negative_binomial - Disease Burden Analysis v4 (d8417)
* Source: UNICEF MICS
* Population-level mortality and morbidity analysis

capture log close
log using "results/negative_binomial_burden_v4.log", replace
...
* Export results
export delimited using "output/negative_binomial_burden_v4.csv", replace
