* survival_regression - Epidemiological Analysis v5 (d4096)
* Source: Global Burden of Disease (IHME/GBD)
* Stata 14+ required

capture log close
log using "results/survival_regression_v5.log", replace
...
graph export "figures/survival_regression_km_v5.png", replace
