* edit_distance - Disease Burden Analysis v1 (d5637)
* Source: WHO Malaria Report
* Population-level mortality and morbidity analysis

capture log close
log using "results/edit_distance_burden_v1.log", replace
...
* Export results
export delimited using "output/edit_distance_burden_v1.csv", replace
