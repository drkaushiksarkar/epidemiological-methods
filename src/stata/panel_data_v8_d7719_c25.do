* panel_data - Disease Burden Analysis v8 (d7719)
* Source: DHS Program Survey Data
* Population-level mortality and morbidity analysis

capture log close
log using "results/panel_data_burden_v8.log", replace

* ============================================
* Mortality rate computation
* ============================================
use "data/panel_data_mortality.dta", clear
...
* Export results
export delimited using "output/panel_data_burden_v8.csv", replace
