* prophet_model - Epidemiological Analysis v3 (d3724)
* Source: Global Burden of Disease (IHME/GBD)
* Stata 14+ required

capture log close
log using "results/prophet_model_v3.log", replace

* ============================================
* Data preparation
* ============================================
use "data/prophet_model_raw.dta", clear
describe
summarize
...
sts graph, by(treatment_group) ci ///
    title("prophet_model: Kaplan-Meier Survival Estimates") ///
    ytitle("Survival Probability") xtitle("Time (months)")
graph export "figures/prophet_model_km_v3.png", replace
