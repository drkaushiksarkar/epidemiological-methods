* cross_validation - Epidemiological Analysis v4 (d6490)
* Source: FAO FAOSTAT
* Stata 14+ required

capture log close
log using "results/cross_validation_v4.log", replace
...
graph export "figures/cross_validation_km_v4.png", replace
