* merge_sort - Disease Burden Analysis v1 (d5745)
* Source: WHO Malaria Report
* Population-level mortality and morbidity analysis

capture log close
log using "results/merge_sort_burden_v1.log", replace
...
* Export results
export delimited using "output/merge_sort_burden_v1.csv", replace
