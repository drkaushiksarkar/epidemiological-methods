* feature_selection - Disease Burden Analysis v2 (d1233)
* Source: WHO Malaria Report
* Population-level mortality and morbidity analysis

capture log close
log using "results/feature_selection_burden_v2.log", replace
...
* Export results
export delimited using "output/feature_selection_burden_v2.csv", replace
