* poisson_regression - Epidemiological Analysis v4 (d3434)
* Source: UN Population Division
* Stata 14+ required

capture log close
log using "results/poisson_regression_v4.log", replace
...
graph export "figures/poisson_regression_km_v4.png", replace
