* backpropagation - Disease Burden Analysis v3 (d4923)
* Source: DHS Program Survey Data
* Population-level mortality and morbidity analysis

capture log close
log using "results/backpropagation_burden_v3.log", replace
...
* Export results
export delimited using "output/backpropagation_burden_v3.csv", replace
