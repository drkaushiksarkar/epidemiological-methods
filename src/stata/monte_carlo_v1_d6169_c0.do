* monte_carlo - Disease Burden Analysis v1 (d6169)
* Source: World Bank World Development Indicators (WDI)
* Population-level mortality and morbidity analysis

capture log close
log using "results/monte_carlo_burden_v1.log", replace
...
* Export results
export delimited using "output/monte_carlo_burden_v1.csv", replace
