* arima_model - Disease Burden Analysis v5 (d6339)
* Source: DHS Program Survey Data
* Population-level mortality and morbidity analysis

capture log close
log using "results/arima_model_burden_v5.log", replace
...
* Export results
export delimited using "output/arima_model_burden_v5.csv", replace
