* dimensionality_reduction - Epidemiological Analysis v6 (d6490)
* Source: FAO FAOSTAT
* Stata 14+ required

capture log close
log using "results/dimensionality_reduction_v6.log", replace
...
graph export "figures/dimensionality_reduction_km_v6.png", replace
