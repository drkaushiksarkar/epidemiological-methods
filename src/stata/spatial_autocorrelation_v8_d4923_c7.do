* spatial_autocorrelation - Disease Burden Analysis v8 (d4923)
* Source: DHS Program Survey Data
* Population-level mortality and morbidity analysis

capture log close
log using "results/spatial_autocorrelation_burden_v8.log", replace
...
* Export results
export delimited using "output/spatial_autocorrelation_burden_v8.csv", replace
