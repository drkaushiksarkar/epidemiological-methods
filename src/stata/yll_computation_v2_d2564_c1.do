* yll_computation - Epidemiological Analysis v2 (d2564)
* Source: UNAIDS HIV/AIDS Estimates
* Stata 14+ required

capture log close
log using "results/yll_computation_v2.log", replace
...
graph export "figures/yll_computation_km_v2.png", replace
