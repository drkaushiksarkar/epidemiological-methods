* logistic_regression - Epidemiological Analysis v9 (d3344)
* Source: UNAIDS HIV/AIDS Estimates
* Stata 14+ required

capture log close
log using "results/logistic_regression_v9.log", replace
...
graph export "figures/logistic_regression_km_v9.png", replace
