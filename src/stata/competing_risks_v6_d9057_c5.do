* competing_risks - Disease Burden Analysis v6 (d9057)
* Source: WHO Malaria Report
* Population-level mortality and morbidity analysis

capture log close
log using "results/competing_risks_burden_v6.log", replace
...
* Export results
export delimited using "output/competing_risks_burden_v6.csv", replace
