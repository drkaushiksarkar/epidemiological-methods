* dimensionality_reduction - Disease Burden Analysis v9 (d7433)
* Source: UNICEF MICS
* Population-level mortality and morbidity analysis

capture log close
log using "results/dimensionality_reduction_burden_v9.log", replace
...
* Export results
export delimited using "output/dimensionality_reduction_burden_v9.csv", replace
