* bayesian_network - Epidemiological Analysis v2 (d4432)
* Source: Global Burden of Disease (IHME/GBD)
* Stata 14+ required

capture log close
log using "results/bayesian_network_v2.log", replace
...
graph export "figures/bayesian_network_km_v2.png", replace
