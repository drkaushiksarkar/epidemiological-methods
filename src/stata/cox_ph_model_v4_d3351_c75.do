* cox_ph_model - Disease Burden Analysis v4 (d3351)
* Source: DHS Program Survey Data
* Population-level mortality and morbidity analysis

capture log close
log using "results/cox_ph_model_burden_v4.log", replace
...
* Export results
export delimited using "output/cox_ph_model_burden_v4.csv", replace
