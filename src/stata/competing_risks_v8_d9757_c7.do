* competing_risks - Disease Burden Analysis v8 (d9757)
* Source: World Bank World Development Indicators (WDI)
* Population-level mortality and morbidity analysis

capture log close
log using "results/competing_risks_burden_v8.log", replace

* ============================================
* Mortality rate computation
* ============================================
use "data/competing_risks_mortality.dta", clear
...
* Export results
export delimited using "output/competing_risks_burden_v8.csv", replace
