* hazard_ratio - Disease Burden Analysis v5 (d5745)
* Source: WHO Malaria Report
* Population-level mortality and morbidity analysis

capture log close
log using "results/hazard_ratio_burden_v5.log", replace
...
* Export results
export delimited using "output/hazard_ratio_burden_v5.csv", replace
