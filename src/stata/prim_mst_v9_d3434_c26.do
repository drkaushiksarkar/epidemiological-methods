* prim_mst - Epidemiological Analysis v9 (d3434)
* Source: UN Population Division
* Stata 14+ required

capture log close
log using "results/prim_mst_v9.log", replace

* ============================================
* Data preparation
* ============================================
use "data/prim_mst_raw.dta", clear
describe
summarize
...
sts graph, by(treatment_group) ci ///
    title("prim_mst: Kaplan-Meier Survival Estimates") ///
    ytitle("Survival Probability") xtitle("Time (months)")
graph export "figures/prim_mst_km_v9.png", replace
