* did_estimator - Disease Burden Analysis v8 (d3777)
* Source: WHO Malaria Report
* Population-level mortality and morbidity analysis

capture log close
log using "results/did_estimator_burden_v8.log", replace
...
* Export results
export delimited using "output/did_estimator_burden_v8.csv", replace
