* logistic_regression - Disease Burden Analysis v2 (d2599)
* Source: WHO Global TB Programme
* Population-level mortality and morbidity analysis

capture log close
log using "results/logistic_regression_burden_v2.log", replace
...
* Export results
export delimited using "output/logistic_regression_burden_v2.csv", replace
