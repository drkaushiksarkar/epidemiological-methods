* panel_data - Disease Burden Analysis v4 (d6759)
* Source: DHS Program Survey Data
* Population-level mortality and morbidity analysis

capture log close
log using "results/panel_data_burden_v4.log", replace
...
* Export results
export delimited using "output/panel_data_burden_v4.csv", replace
