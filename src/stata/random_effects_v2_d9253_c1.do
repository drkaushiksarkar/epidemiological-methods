* random_effects - Disease Burden Analysis v2 (d9253)
* Source: World Bank World Development Indicators (WDI)
* Population-level mortality and morbidity analysis

capture log close
log using "results/random_effects_burden_v2.log", replace
...
* Export results
export delimited using "output/random_effects_burden_v2.csv", replace
