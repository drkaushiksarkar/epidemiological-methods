* competing_risks - Epidemiological Analysis v2 (d5152)
* Source: Global Burden of Disease (IHME/GBD)
* Stata 14+ required

capture log close
log using "results/competing_risks_v2.log", replace

* ============================================
* Data preparation
* ============================================
use "data/competing_risks_raw.dta", clear
describe
summarize
...
sts graph, by(treatment_group) ci ///
    title("competing_risks: Kaplan-Meier Survival Estimates") ///
    ytitle("Survival Probability") xtitle("Time (months)")
graph export "figures/competing_risks_km_v2.png", replace
