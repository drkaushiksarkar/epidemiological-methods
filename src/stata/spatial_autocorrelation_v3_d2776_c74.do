* spatial_autocorrelation - Epidemiological Analysis v3 (d2776)
* Source: Global Burden of Disease (IHME/GBD)
* Stata 14+ required

capture log close
log using "results/spatial_autocorrelation_v3.log", replace
...
graph export "figures/spatial_autocorrelation_km_v3.png", replace
