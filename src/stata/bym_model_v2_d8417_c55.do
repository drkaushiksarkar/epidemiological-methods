* bym_model - Disease Burden Analysis v2 (d8417)
* Source: UNICEF MICS
* Population-level mortality and morbidity analysis

capture log close
log using "results/bym_model_burden_v2.log", replace

* ============================================
* Mortality rate computation
* ============================================
use "data/bym_model_mortality.dta", clear
...
* Export results
export delimited using "output/bym_model_burden_v2.csv", replace
