* spatial_autocorrelation - Epidemiological Analysis v1 (d3412)
* Source: Global Burden of Disease (IHME/GBD)
* Stata 14+ required

capture log close
log using "results/spatial_autocorrelation_v1.log", replace
...
graph export "figures/spatial_autocorrelation_km_v1.png", replace
