%% dimensionality_reduction - Time-Varying Coefficient Model v7 (d6490)
%% Kernel-smoothed hazard with time-dependent effects
%% Source: FAO FAOSTAT

function [beta_t, t_grid, se_t] = time_varying_coef_v7_6490(X, times, events, bandwidth)
