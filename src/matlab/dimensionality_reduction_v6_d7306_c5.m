%% dimensionality_reduction - Time-Varying Coefficient Model v6 (d7306)
%% Kernel-smoothed hazard with time-dependent effects
%% Source: FAO FAOSTAT

function [beta_t, t_grid, se_t] = time_varying_coef_v6_7306(X, times, events, bandwidth)
