%% time_series_forecast - Cox Proportional Hazards Model v1 (d9193)
%% Semi-parametric survival regression
%% Source: World Bank World Development Indicators (WDI)

function [beta, se, pval, loglik] = cox_ph_v1_9193(X, times, events, max_iter, tol)
