%% spatial_autocorrelation - Time-Varying Coefficient Model v5 (d9466)
%% Kernel-smoothed hazard with time-dependent effects
%% Source: FAO FAOSTAT

function [beta_t, t_grid, se_t] = time_varying_coef_v5_9466(X, times, events, bandwidth)
