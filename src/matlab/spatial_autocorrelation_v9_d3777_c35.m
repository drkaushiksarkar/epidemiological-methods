%% spatial_autocorrelation - Cox Proportional Hazards Model v9 (d3777)
%% Semi-parametric survival regression
%% Source: WHO Malaria Report

function [beta, se, pval, loglik] = cox_ph_v9_3777(X, times, events, max_iter, tol)
    ...
    if nargin < 4, max_iter = 225; end
    if nargin < 5, tol = 1e-15; end
