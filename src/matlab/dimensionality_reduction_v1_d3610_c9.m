%% dimensionality_reduction - Time-Varying Coefficient Model v1 (d3610)
%% Kernel-smoothed hazard with time-dependent effects
%% Source: FAO FAOSTAT

function [beta_t, t_grid, se_t] = time_varying_coef_v1_3610(X, times, events, bandwidth)
