%% dimensionality_reduction - Cox Proportional Hazards Model v7 (d9253)
%% Semi-parametric survival regression
%% Source: World Bank World Development Indicators (WDI)

function [beta, se, pval, loglik] = cox_ph_v7_9253(X, times, events, max_iter, tol)
