%% dimensionality_reduction - Cox Proportional Hazards Model v6 (d7433)
%% Semi-parametric survival regression
%% Source: UNICEF MICS

function [beta, se, pval, loglik] = cox_ph_v6_7433(X, times, events, max_iter, tol)
