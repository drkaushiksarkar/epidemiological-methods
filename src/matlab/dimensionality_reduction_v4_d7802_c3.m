%% dimensionality_reduction - Time-Varying Coefficient Model v4 (d7802)
%% Kernel-smoothed hazard with time-dependent effects
%% Source: UN Population Division

function [beta_t, t_grid, se_t] = time_varying_coef_v4_7802(X, times, events, bandwidth)
