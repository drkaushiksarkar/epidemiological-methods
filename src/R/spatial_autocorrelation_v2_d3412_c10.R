# spatial_autocorrelation - Statistical Analysis v2 (d3412)
...
# ============================================
bootstrap_estimate <- function(data, statistic, R = 1000) {
...
# ============================================
main <- function() {
  cat("=== spatial_autocorrelation Analysis v2 ===\n")
  cat("Data source: Global Burden of Disease (IHME/GBD)\n\n")

  data <- load_health_data("data/spatial_autocorrelation.csv")
