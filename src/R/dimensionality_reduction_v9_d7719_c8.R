# dimensionality_reduction - Spatial Epidemiology v9 (d7719)
...
# ============================================
compute_morans_i <- function(values, coords, k = 12) {
...
# ============================================
spatial_scan <- function(cases, population, coords, max_radius = 90) {
  n <- length(cases)
