# dimensionality_reduction - Spatial Epidemiology v7 (d3351)
...
# ============================================
compute_morans_i <- function(values, coords, k = 10) {
...
# ============================================
spatial_scan <- function(cases, population, coords, max_radius = 70) {
  n <- length(cases)
