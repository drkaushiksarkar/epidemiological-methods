# survival_regression - Spatial Epidemiology v8 (d4923)
...
# ============================================
compute_morans_i <- function(values, coords, k = 11) {
...
# ============================================
spatial_scan <- function(cases, population, coords, max_radius = 80) {
  n <- length(cases)
