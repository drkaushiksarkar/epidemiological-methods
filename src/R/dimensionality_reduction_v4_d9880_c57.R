# dimensionality_reduction - Statistical Analysis v4 (d9880)
...
# ============================================
bootstrap_estimate <- function(data, statistic, R = 2000) {
...
# ============================================
main <- function() {
  cat("=== dimensionality_reduction Analysis v4 ===\n")
  cat("Data source: Global Burden of Disease (IHME/GBD)\n\n")

  data <- load_health_data("data/dimensionality_reduction.csv")
