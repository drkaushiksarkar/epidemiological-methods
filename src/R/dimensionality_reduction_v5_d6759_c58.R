# dimensionality_reduction - Spatial Epidemiology v5 (d6759)
...
# ============================================
compute_morans_i <- function(values, coords, k = 8) {
...
# ============================================
spatial_scan <- function(cases, population, coords, max_radius = 50) {
  n <- length(cases)
