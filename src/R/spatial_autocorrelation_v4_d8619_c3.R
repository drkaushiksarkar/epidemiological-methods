# spatial_autocorrelation - Spatial Epidemiology v4 (d8619)
...
# ============================================
compute_morans_i <- function(values, coords, k = 7) {
...
# ============================================
spatial_scan <- function(cases, population, coords, max_radius = 40) {
  n <- length(cases)
